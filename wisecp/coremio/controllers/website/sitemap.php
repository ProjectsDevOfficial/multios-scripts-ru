        ...
        public function main(){
            ...
            if($categories){
                foreach($categories AS $row){
                    ...
                    elseif($row["type"] == "software" && Config::get("options/pg-activation/software"))
            ...
            if(!$hide_normal_page && isset($is_pages["news"])) $links[]   = $this->CRLink("news");
            if(!$hide_normal_page && isset($is_pages["articles"])) $links[]   = $this->CRLink("articles");
            if(!$hide_normal_page && isset($is_pages["references"])) $links[]   = $this->CRLink("references");

            $links[]   = $this->CRLink("contact");

            if(Config::get("options/kbase-system") && isset($is_pages["kbase"]))
                $links[]   = $this->CRLink("kbase");

            if(Config::get("options/pg-activation/software") && isset($is_pages["software"]))
