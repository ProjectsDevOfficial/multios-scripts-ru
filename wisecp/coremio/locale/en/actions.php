...
return [
    ...
    'added-new-address'                                   => [
        'content'   => 'New billing profile added',
        'variables' => '{id}',
    ],
    'changed-address'                                     => [
    ...
    'orders-has-been-terminated'                          => [
        'content'   => '{count} orders were deleted from the API.',
        'variables' => '{count}',
    ],
    'reminder-deleted'                                    => [
    ...
    'GDPR personal data downloaded'                     => "The personal data file has been downloaded.",
];
