...
return [
    ...
    'updates-text1'                     => 'Your version is up to date',
    'updates-text2'                     => ' There is no new version or it has not yet reached your system',
    ...
    'health-text5'                      => 'Congratulations!',
    'health-text6'                      => 'Your system health looks good',
    ...
    'health-errors-php-version'         => 'It is recommended that your PHP version be 8.1+.',
    ...
    'health-db-version'                 => 'Database Server Version',
    'health-errors-db-version'          => 'Your database server version appears to be low. This can cause many problems.<br>--<br>Your database server version: <strong style=\'color: #9f261e;\'>{version}</strong><br>Must have: <strong style=\'color: #5eae62;\'>{suggested1}</strong> or <strong style=\'color: #5eae62;\'>{suggested2}</strong>',
    'health-successes-db-version'       => 'Your database server version looks OK.',
    ...
    'health-xml'                        => 'XML Reader',
    'health-successes-xml'              => '<strong>simplexml_load_string()</strong> is available on your server.',
    'health-errors-xml'                 => 'The <strong>simplexml_load_string()</strong> function could not be found on your server.',
    ...
    'update-addon-tx1'                  => 'Unable to Continue',
    'update-addon-tx2'                  => 'The update package for your license is inactive',
    'update-addon-tx3'                  => 'Your license\'s annual "Update/Support" package must be active for the upgrade.',
    'update-addon-tx4'                  => 'To continue with the upgrade, activate your "Update/Support" package in the license details in your "my.wisecp.com" client area and run the upgrade again.',
    'update-addon-tx5'                  => 'Go to my.wisecp.com',
    'update-addon-tx6'                  => 'Run Again',
    'update-backup-skip'                => 'Skip the backup process. I already made the backup.',
    'error11'                           => 'The new version requires up-to-date Ioncube. Please make sure you have at least "Ioncube v12" installed on your server.',
    'quick-support'                     => 'Premium+ Support',
    'health-situation-no-errors'        => 'No error.',
    'health-situation-no-warnings'      => 'No warning.',
];
