...
return [
    ...
    'server-is-full'                         => 'The server "<strong>{name}</strong>" has reached the maximum number of accounts. ',
    'license-ip-check'                       => 'The current IP address does not match the "<strong>{new}</strong>" IP address registered in your WISECP license.',
    'button-repair-cronjob-ip-mismatch'      => 'Update IP Address',
    'cronjobs-change-file'                   => 'You need to change the cronjob command defined on your server to <strong class=\'headbar-border\'>{command}</strong> Otherwise automatic processes cannot be executed.',
    'email-pipe-error'                       => "There was a problem with the email piping system. Emails cannot be imported. Please check your settings.",
];
