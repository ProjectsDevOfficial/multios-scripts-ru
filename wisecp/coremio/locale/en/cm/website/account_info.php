...
return [
    ...
    'add-new-address'               => 'Create New Billing Profile',
    'edit-address'                  => 'Update Billing Profile',
    'country'                       => 'Country',
    'city'                          => 'State',
    ...
    'select-your'                   => 'Select',
    'add-address-submit-button'     => 'Add New Profile',
    'edit-address-submit-button'    => 'Update Profile',
    'current-addresses'             => 'My Billing Profiles',
    ...
    'success2'                      => 'The billing profile was successfully updated',
    'success3'                      => 'Operation Successfully Done.',
    'gdpr-tx1'                      => 'Your Personal Data',
    'gdpr-tx2'                      => 'You can download all your personal data as an XML file with a single click, request anonymization or request its complete removal. Also, please make sure you authorize our company to store and process your personal data. You can be sure that all your data will be stored and processed in accordance with GDPR.',
    'gdpr-tx3'                      => 'Authorization',
    'gdpr-tx4'                      => 'I have read and understood the <a target="_blank" href="{link}"><strong>Privacy Policy</strong></a>. I authorize the storage and processing of my data in accordance with GDPR.',
    'gdpr-tx5'                      => 'You gave your consent on <strong>{date}</strong>',
    'gdpr-tx6'                      => 'Your approval is required in order to continue with your process.',
    'gdpr-tx7'                      => 'Download Data',
    'gdpr-tx8'                      => 'Download XML',
    'gdpr-tx9'                      => 'You can download all data about your account in XML file format.',
    'gdpr-tx10'                     => 'Data to Download: Account Info, Invoices, Services, Support Tickets, Sent Messages, Activity Logs',
    'gdpr-tx11'                     => 'You last downloaded your data on <strong>{date}</strong>',
    'gdpr-tx12'                     => 'Data Removal Request',
    'gdpr-tx13'                     => 'According to GDPR law, you can request the removal or anonymization of your data. Once your request is approved, you will no longer be able to access your account and continue to use your services.',
    'gdpr-tx14'                     => 'Delete my data',
    'gdpr-tx15'                     => 'Anonymize my data',
    'gdpr-tx16'                     => 'You requested "<strong>{type}</strong>" on <strong>{date}</strong>',
    'gdpr-tx17'                     => 'Delete my data',
    'gdpr-tx18'                     => 'Anonymize my data',
    'gdpr-tx19'                     => 'You are creating a request for process "<strong>Delete my data</strong>". Once your request is approved, you will no longer be able to access your account and continue to use your services.',
    'gdpr-tx20'                     => 'If you need more information on this subject, please contact us first of all.',
    'gdpr-tx21'                     => 'Got it, complete the process',
    'gdpr-tx22'                     => 'You are creating a request for process "<strong>Anonymize my data</strong>". Once your request is approved, you will no longer be able to access your account and continue to use your services.',
    'gdpr-tx23'                     => 'Cancel Request',
    'gdpr-tx24'                     => 'You have submitted a request before',
    'gdpr-tx25'                     => 'Request Not Accepted',
    'gdpr-tx26'                     => 'Reason',
    'address-profile-tx1'           => 'Full Name',
    'address-profile-tx2'           => 'Update unpaid invoices with this',
    'address-profile-tx3'           => 'Default Billing Profile',
    'required-billing-profile'      => "Please define address profile so that your service period invoices can be generated.",
];
