...
return [
    ...
    'creq-service-empty'            => "Please select related service",
    'creq-service-not-active'       => "Your service is not active. Your service must be active before you can create support ticket.",
];
