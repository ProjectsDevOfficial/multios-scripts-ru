<?php
    return [
        ...
        'prohibited-alert'               => 'Due to some restrictions, this process is not allowed.',
        'affiliate-tx75'                 => 'Your Affiliate Account Has Been Canceled!',
        'affiliate-tx76'                 => 'Your affiliatea ccount has been canceled due to violation of our affiliate agreement. SEE:
                                <a target="_blank" href="#" style="color: white;text-decoration: underline;">click</a>',
        'affiliate-tx77'                 => 'Reason',
        'affiliate-tx78'                 => 'This means that you will no longer be able to earn commission from affiliate marketing and even if there is a finalized balance in your account, it will not be paid.',
    ];
