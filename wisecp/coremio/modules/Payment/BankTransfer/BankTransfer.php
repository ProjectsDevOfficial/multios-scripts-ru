<?php
    class BankTransfer {
        ...
        public $links;
        public $accounts,$checkout_id=0,$checkout;
        ...
        function __construct(){
            ...
            $functions['notification'] = function (){
                ...
                Session::set("banktransfer_data",Utility::jencode($ses_data));
        ...
        public function payment_result(){
            ...
            $pnf = $this->config["settings"]["pnf"] ?? false;
            ...
            if($data && $checkout["type"] == "invoice-bulk-payment")
            {
