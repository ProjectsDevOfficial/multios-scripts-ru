                    ...
                    <div class="creditcardform-con">
                        ...
                        <div class="creditcardinfo-left">
                            ...
                            <label>
                                ...
                                <input name="card_name" id="i_card_name" placeholder="<?php echo __("website/payment/card-tx18"); ?>" type="text" value="">
                            </label>
                            <div class="yuzde50">
                                <label >
                                    <span class="kinfo"><?php echo __("website/payment/card-tx7"); ?></span>
                                    <input inputmode="numeric" name="card_expiry" id="i_card_expiry" placeholder="<?php echo __("website/payment/card-tx19"); ?>" type="text" value="">
                                </label></div>
                            <div class="yuzde50">
                                <label class="yuzde50">
