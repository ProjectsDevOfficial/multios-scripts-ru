<?php
    ...
    $installment_rates = Utility::jdecode(FileManager::file_read($module->dir."installment-rates.json"),true);
    ...
    <div id="PayTR_tab">
        ...
        <div id="PayTR_tab-settings" class="modules-tabs-content" style="display: block">
            ...
            <div class="formcon type_direct" style="<?php echo isset($CONFIG["settings"]["payment_type"]) && $CONFIG["settings"]["payment_type"] != "direct" ? 'display:none;' : ''; ?>">
                <div class="yuzde30"><?php echo __("website/payment/card-tx29"); ?></div>
                <div class="yuzde70">
                    ...
                    <span class="kinfo"><?php echo __("website/payment/card-tx30"); ?></span>
                </div>
            </div>

            <div class="formcon type_direct" style="<?php echo isset($CONFIG["settings"]["payment_type"]) && $CONFIG["settings"]["payment_type"] != "direct" ? 'display:none;' : ''; ?>">
                <div class="yuzde30"><?php echo __("website/payment/card-tx31"); ?></div>
                <div class="yuzde70">
                    ...
                    <span class="kinfo"><?php echo __("website/payment/card-tx32"); ?></span>
                    <div class="clear"></div>
                    <span class="kinfo"><?php echo __("website/payment/card-tx33"); ?></span>
                </div>
            </div>
        ...
        <div id="PayTR_tab-installment" class="modules-tabs-content" style="display: none">
            ...
            <div class="blue-info" style="margin-bottom:20px;">
                <div class="padding15">
                    <i class="fa fa-info-circle" aria-hidden="true"></i>
                    <p><?php echo __("website/payment/card-tx34"); ?> </p>
                    <ul>
                        <li>- <?php echo __("website/payment/card-tx35"); ?> </li>
                        <li>- <?php echo __("website/payment/card-tx36"); ?> </li>
                    </ul>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        <td colspan="9" align="center">
                            <h5 style="display: inline-block;"><strong><?php echo __("website/payment/card-tx37"); ?></strong> (%)</h5>
                            ...
                            <tr>
                                ...
                                <?php
                                    foreach($cards AS $card)
                                    {
                                        ...
                                        if(strlen($rate) >= 1) $rate = round((float) $rate,2);
                                        ?>
