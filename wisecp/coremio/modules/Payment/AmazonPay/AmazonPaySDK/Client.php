...
if (!interface_exists('\Psr\Log\LoggerAwareInterface'))
    require_once(CORE_DIR."vendor".DS."psr".DS."log".DS."Psr".DS."Log".DS."LoggerAwareInterface.php");

if (!interface_exists('\Psr\Log\LoggerInterface'))
    require_once(CORE_DIR."vendor".DS."psr".DS."log".DS."Psr".DS."Log".DS."LoggerInterface.php");
