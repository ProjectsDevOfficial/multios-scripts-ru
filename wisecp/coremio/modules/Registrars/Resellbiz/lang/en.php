...
return [
    'name'              => 'Resellbiz',
    'description'       => 'With resell.biz, one of the popular domain name registrars, all domain name transactions can be made instantaneously through the domain API. To do this, define your resell.biz client account information in the following fields.',
    ...
    'fields'            => [
        ...
        'cost-currency' => 'Your Resellbiz Currency',
    ...
    'desc'              => [
        ...
        'customer-id'   => 'Resellbiz is customer account ID information, created in your Resellership account. All transactions are carried out via the customer\'s account.',
