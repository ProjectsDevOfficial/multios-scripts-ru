...
function Namecheap_open_tab(elem, tabName){
    var owner = "Namecheap_tab";
...
<div id="Namecheap_tab">
    <ul class="modules-tabs">
        <li><a href="javascript:Namecheap_open_tab(this,'detail');" data-tab="detail" class="modules-tab-item active"><?php echo $LANG["tab-detail"]; ?></a></li>
        <li><a href="javascript:Namecheap_open_tab(this,'import');" data-tab="import" class="modules-tab-item"><?php echo $LANG["tab-import"]; ?></a></li>
    </ul>

    <div id="Namecheap_tab-detail" class="modules-tabs-content" style="display: block">

        <form action="<?php echo Controllers::$init->getData("links")["controller"]; ?>" method="post" id="NamecheapSettings">
            <input type="hidden" name="operation" value="module_controller">
            <input type="hidden" name="module" value="Namecheap">
            ...
            <div class="formcon" id="Namecheap_sandbox_username_con" style="<?php echo $CONFIG["settings"]["test-mode"] ? '' : 'display:none;'; ?>">
            ...
            <div class="formcon" id="Namecheap_sandbox_api_key_con" style="<?php echo $CONFIG["settings"]["test-mode"] ? '' : 'display:none;'; ?>">
            ...
            <div class="formcon">
                ...
                <div class="yuzde70">
                    <input<?php echo $CONFIG["settings"]["test-mode"] ? ' checked' : ''; ?> type="checkbox" name="test-mode" value="1" class="sitemio-checkbox" id="Namecheap_test-mode" onchange="if($(this).prop('checked')) $('#Namecheap_sandbox_api_key_con,#Namecheap_sandbox_username_con').css('display','block'); else $('#Namecheap_sandbox_api_key_con,#Namecheap_sandbox_username_con').css('display','none');">
                    <label class="sitemio-checkbox-label" for="Namecheap_test-mode"></label>
            ...
            <div class="formcon">
                ...
                <div class="yuzde70">
                    <input<?php echo isset($CONFIG["settings"]["adp"]) && $CONFIG["settings"]["adp"] ? ' checked' : ''; ?> type="checkbox" name="adp" value="1" id="Namecheap_adp" class="checkbox-custom">
                    <label class="checkbox-custom-label" for="Namecheap_adp">
            ...
            <div class="formcon">
                ...
                <div class="yuzde70">
                    <a class="lbtn" href="javascript:open_modal('Namecheap_import_tld');void 0;"><?php echo $LANG["import-tld-button"]; ?></a>
                    <div class="clear"></div>
            ...
            <div style="float:left;" class="guncellebtn yuzde30"><a id="Namecheap_testConnect" href="javascript:void(0);" class="lbtn"><i class="fa fa-plug" aria-hidden="true"></i> <?php echo $LANG["test-button"]; ?></a></div>

            <div style="float:right;" class="guncellebtn yuzde30"><a id="Namecheap_submit" href="javascript:void(0);" class="yesilbtn gonderbtn"><?php echo $LANG["save-button"]; ?></a></div>

        </form>
        <script type="text/javascript">
            $(document).ready(function(){
                $("#Namecheap_testConnect").click(function(){
                    $("#NamecheapSettings input[name=controller]").val("test_connection");
                    MioAjaxElement($(this),{
                        waiting_text:waiting_text,
                        progress_text:progress_text,
                        result:"Namecheap_handler",
                    });
                });

                $("#Namecheap_submit").click(function(){
                    $("#NamecheapSettings input[name=controller]").val("settings");
                    MioAjaxElement($(this),{
                        waiting_text:waiting_text,
                        progress_text:progress_text,
                        result:"Namecheap_handler",
            ...
            function Namecheap_handler(result){
                if(result != ''){
                    var solve = getJson(result);
                    if(solve !== false){
                        if(solve.status == "error"){
                            if(solve.for != undefined && solve.for != ''){
                                $("#NamecheapSettings "+solve.for).focus();
                                $("#NamecheapSettings "+solve.for).attr("style","border-bottom:2px solid red; color:red;");
                                $("#NamecheapSettings "+solve.for).change(function(){
    ...
    <div id="Namecheap_tab-import" class="modules-tabs-content" style="display: none;">
        ...
        <script type="text/javascript">
            ...
            function Namecheap_import_handler(result){
                if(result != ''){
                    var solve = getJson(result);
                    if(solve !== false){
                        if(solve.status == "error"){
                            if(solve.for != undefined && solve.for != ''){
                                $("#NamecheapImport "+solve.for).focus();
                                $("#NamecheapImport "+solve.for).attr("style","border-bottom:2px solid red; color:red;");
                                $("#NamecheapImport "+solve.for).change(function(){
                                    $(this).removeAttr("style");
                                });
                            }
                            if(solve.message != undefined && solve.message != '')
            ...
            $(document).ready(function(){
                ...
                $("#Namecheap_import_submit").click(function(){
                    MioAjaxElement($(this),{
                        waiting_text:waiting_text,
                        progress_text:progress_text,
                        result:"Namecheap_import_handler",
                    });
                });

                $('#Namecheap_list_domains').DataTable({
                    "columnDefs": [
                        {
                            "targets": [0],
                            "visible":false,
        ...
        <form action="<?php echo Controllers::$init->getData("links")["controller"]; ?>" method="post" id="NamecheapImport">
            <input type="hidden" name="operation" value="module_controller">
            <input type="hidden" name="module" value="Namecheap">
            <input type="hidden" name="controller" value="import">

            <table width="100%" id="Namecheap_list_domains" class="table table-striped table-borderedx table-condensed nowrap">
            ...
            <div class="guncellebtn yuzde20" style="float: right;">
                <a href="javascript:void(0);" id="Namecheap_import_submit" class="gonderbtn mavibtn"><?php echo $LANG["import-button"]; ?></a>
            </div>
...
<div id="Namecheap_import_tld" style="display: none;" data-izimodal-title="<?php echo $LANG["fields"]["import-tld"]; ?>">
    <script type="text/javascript">
        $(document).ready(function(){

            $("#Namecheap_import_tld_submit").on("click",function(){
                var request = MioAjax({
                    button_element:this,
    ...
    <div class="padding20">
        ...
        <div align="center">
            <div class="yuzde50">
                <a class="yesilbtn gonderbtn" href="javascript:void 0;" id="Namecheap_import_tld_submit"><i class="fa fa-check" aria-hidden="true"></i> <?php echo ___("needs/ok"); ?></a>
            </div>
        </div>
