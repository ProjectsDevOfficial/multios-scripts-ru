...
<div id="InternetX_tab">
    ...
    <div id="InternetX_tab-detail" class="modules-tabs-content" style="display: block">
        ...
        <form action="<?php echo Controllers::$init->getData("links")["controller"]; ?>" method="post" id="InternetXSettings">
            ...
            <div class="formcon">
                <div class="yuzde30">Domain Check URL</div>
                <div class="yuzde70">
                    <input type="text" name="check_url" value="<?php echo $CONFIG["settings"]["check_url"] ?? 'https://api.autodns.com/v1/domainstudio'; ?>">
                    <span class="kinfo"></span>
                </div>
            </div>

            <div class="formcon">
                <div class="yuzde30">Domain Check Username</div>
                <div class="yuzde70">
                    <input type="text" name="check_username" value="<?php echo $CONFIG["settings"]["check_username"] ?? ''; ?>">
                    <span class="kinfo"></span>
                </div>
            </div>

            <div class="formcon">
                <div class="yuzde30">Domain Check Password</div>
                <div class="yuzde70">
                    <input type="password" name="check_password" value="<?php echo ($CONFIG["settings"]["check_password"] ?? '') ? "*****" : ''; ?>">
                    <span class="kinfo"></span>
                </div>
            </div>
