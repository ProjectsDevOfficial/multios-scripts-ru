<?php
    ...
    class OztekSMS
    {
        ...
        {
            if(!class_exists("OztekSMSLib")) include __DIR__.DS."Source".DS."class.php";
            ...
            $ozelkod            = $config["ozelkod"];
            $title              = $config["origin"];
            $this->instance = new OztekSMSLib($username_id,$username,$password,$ozelkod);
            $this->title = $title;
        }

        public function change_config($username_id,$username,$password,$ozelkod){
            $this->instance = new OztekSMSLib($username_id,$username,$password,$ozelkod);
        }
