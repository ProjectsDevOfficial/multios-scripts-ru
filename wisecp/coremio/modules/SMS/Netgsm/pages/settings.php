...
<form action="<?php echo Controllers::$init->getData("links")["controller"]; ?>" method="post" id="NetgsmSettings">
    ...
    <div class="formcon">
        <div class="yuzde30">OTP ile Gönderim</div>
        <div class="yuzde70">
            <input<?php echo ($CONFIG["otp"] ?? false) ? ' checked' : ''; ?> type="checkbox" name="otp" value="1" id="netgsm_otp" class="checkbox-custom">
            <label class="checkbox-custom-label" for="netgsm_otp"><span class="kinfo">OTP yöntemi ile doğrulama SMS'i gönderin.</span></label>
        </div>
    </div>
