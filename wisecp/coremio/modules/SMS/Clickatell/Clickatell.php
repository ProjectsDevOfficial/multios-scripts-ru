<?php
    ...
    class Clickatell
    {
        ...
        {
            if(!class_exists("Clickatell_Library")) include __DIR__.DS."Source".DS."class.php";
            ...
            $from_number        = $config["from-number"];
            $this->instance = new Clickatell_Library($api_key,$from_number);
        }
