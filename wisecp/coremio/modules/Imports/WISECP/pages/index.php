...
<div class="importcon">
    ...
    <div id="notice_info"><!-- notice start -->
        ...
        <div class="padding30">
            <?php echo $module->lang["notice-message"]; ?>
    ...
    <form action="<?php echo $module->area_link; ?>" method="post" id="infoForm" enctype="multipart/form-data">
        ...
        <div id="infoForm_layout" style="display: none">
            ...
            <div class="padding30">
                ...
                <div class="formcon">
                    <div class="yuzde30"><?php echo $module->lang["encryption-key"]; ?></div>
                    <div class="yuzde70">
                        <input type="text" name="encryption_key" value="" placeholder="">
                        <span class="kinfo">
                            <?php echo $module->lang["encryption-key-info"]; ?>
                        </span>
                    </div>
                </div>

                <div class="formcon">
                    <div class="yuzde30"><?php echo $module->lang["encryption-key2"]; ?></div>
                    <div class="yuzde70">
                        <input type="text" name="encryption_key2" value="" placeholder="">
                        <span class="kinfo">
                            <?php echo $module->lang["encryption-key2-info"]; ?>
                        </span>
                    </div>
                </div>
