        ...
        <?php
            if($packages)
            {
                foreach($packages AS $g_k => $g_packages)
                {
                    ...
                    {
                        ?>
                        <div class="package-details group-<?php echo $g_k; ?>" id="package-<?php echo $g_k; ?>-<?php echo md5($g_p_k); ?>" style="<?php echo (isset($module_data["reseller"]) && $module_data["reseller"] && isset($module_data["package_r"]) && $module_data["package_r"] == $g_p_k) || ((!isset($module_data["reseller"]) || !$module_data["reseller"]) && isset($module_data["package"]) && $module_data["package"] == $g_p_k) ? '' : 'display:none;'; ?>">
                            <?php
