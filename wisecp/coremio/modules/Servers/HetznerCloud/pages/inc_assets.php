<style type="text/css">
.hetznerneedaction{width:100%;height:560px;background-image:url(<?php echo $module->url."images/hetznerblurbg.jpg";?>);background-repeat:repeat;background-position:top;background-size:100%;text-align:center}
