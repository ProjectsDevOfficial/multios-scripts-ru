<?php
    ...
    if($established){
        ...
        <div class="formcon">
            ...
            <div class="yuzde60">
                <input type="text" name="login_username" value="<?php echo $options["login"]["username"]; ?>" style="width:200px;">
            </div>
        </div>
        ...
        <div class="formcon">
            ...
            <div class="yuzde60">
                <input type="text" name="login_password" value="<?php echo isset($options["login"]["password"]) && $options["login"]["password"] ? $module->hdc($options["login"]["password"]) : ''; ?>" style="width:200px;">
            </div>
        </div>
