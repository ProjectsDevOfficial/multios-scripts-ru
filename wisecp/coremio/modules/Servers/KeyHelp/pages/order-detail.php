<?php
    ...
    $config_options     = $module->config_options($creation_info);
    $selected_plan      = isset($creation_info["plan"]) ? $creation_info["plan"] : '';
                ...
                <select  name="creation_info[plan]" id="creation_info_plan">
                    <?php
                        foreach($config_options["plans"] AS $plan){
                            ...
                            ?>
                            <option<?php echo $is_selected ? ' selected' : ''; ?> value="<?php echo $plan["name"]; ?>"
