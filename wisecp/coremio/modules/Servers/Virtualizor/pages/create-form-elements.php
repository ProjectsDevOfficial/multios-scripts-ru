...
<script type="text/javascript">
    ...
    function change_plan(el){
        ...
        $("input[name='module_data[disk_space]']").val(disk_space).attr('readonly',plan_selected);
        $("input[name='module_data[ram]']").val(ram).attr('readonly',plan_selected);
        $("select[name='module_data[osid]']").val(os_id).attr('readonly',plan_selected);
        $("input[name='module_data[ips]']").val(ips).attr('readonly',plan_selected);
        $("input[name='module_data[bandwidth]']").val(bandwidth).attr('readonly',plan_selected);
        $("input[name='module_data[cpu_cores]']").val(cpu_cores).attr('readonly',plan_selected);
        $("input[name='module_data[network_speed]']").val(network_speed).attr('readonly',plan_selected);
        $("select[name='module_data[mgs][]']").val(mgs).attr('readonly',plan_selected);
        $("input[name='module_data[cpu_units]']").val(cpu_units).attr('readonly',plan_selected);
        $("input[name='module_data[burst_ram]']").val(burst_ram).attr('readonly',plan_selected);
        $("input[name='module_data[swap_ram]']").val(swap_ram).attr('readonly',plan_selected);
        $("input[name='module_data[cpu_percent]']").val(cpu_percent).attr('readonly',plan_selected);
        $("input[name='module_data[ips6]']").val(ips6).attr('readonly',plan_selected);
        $("input[name='module_data[ips6_subnet]']").val(ips6_subnet).attr('readonly',plan_selected);
        $("input[name='module_data[ips_int]']").val(ips_int).attr('readonly',plan_selected);
        $("input[name='module_data[virtio]']").val(virtio).attr('readonly',plan_selected);
        $("input[name='module_data[upload_speed]']").val(upload_speed).attr('readonly',plan_selected);
        $("input[name='module_data[osreinstall_limit]']").val(osreinstall_limit).attr('readonly',plan_selected);
        ...
        $("input[name='module_data[band_suspend]']").prop('checked',band_suspend === '1').attr('readonly',plan_selected);
        $("input[name='module_data[vnc]']").prop('checked',vnc === '1').attr('readonly',plan_selected);
        $("input[name='module_data[virtio]']").prop('checked',virtio === '1').attr('readonly',plan_selected);
        $("input[name='module_data[tuntap]']").prop('checked',tuntap === '1').attr('readonly',plan_selected);
        $("input[name='module_data[admin_managed]']").prop('checked',admin_managed === '1').attr('readonly',plan_selected);
