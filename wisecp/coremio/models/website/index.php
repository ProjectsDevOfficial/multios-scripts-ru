<?php
    ...
    class Model extends Models
    {
        ...
        public function get_software($id=0,$lang=false){
            $this->db_start();
            $select = [
                't1.id',
                't2.route',
        ...
        public function get_products_categories($kind=false,$group_id=0,$limit=false,$clang=false){
            $this->db_start();
            $select = [
                't1.id',
                't1.options',
        ...
        public function get_products($category=0,$limit=false,$clang=''){
            $select = [
                't1.id',
                't1.type',
