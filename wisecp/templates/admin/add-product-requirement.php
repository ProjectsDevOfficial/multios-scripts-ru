                                ...
                                <div class="adminpagecon">
                                    ...
                                    <div class="formcon">
                                        ...
                                        <div style="font-weight:600;" class="yuzde70">
                                            ...
                                            <input type="radio" name="type[<?php echo $lkey; ?>]" value="password" id="type-password-<?php echo $lkey; ?>" class="radio-custom" onchange="if($(this).prop('checked')) $('#options_wrap_<?php echo $lkey; ?>').css('display','none'); else $('#options_wrap_<?php echo $lkey; ?>').css('display','block');">
