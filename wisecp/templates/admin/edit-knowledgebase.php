...
<head>
    <?php
        ...
        $plugins    = ['jquery-ui','tinymce-1','jQtags'];
    ...
    <script type="text/javascript">
        $(document).ready(function(){
            ...
            $(".tags").tagsInput({
                'width':'100%',
                'height': '55px',
                'defaultText':'+ <?php echo ___("needs/button-add"); ?>',
                'interactive':true,
        ...
        function hbackground_delete(){
            ...
            var request = MioAjax({
                ...
                method:"POST",
                data:{operation:"delete_hbackground"}
            },true,true);
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/knowledgebase/page-edit",['{title}' => $page["title"]]); ?></strong></h1>
                ...
                <div id="tab-lang"><!-- tab wrap content start -->
                    ...
                    <?php
                        ...
                        foreach($lang_list AS $lang) {
                            ...
                            $tags       = isset($pagel["tags"]) ? $pagel["tags"] : false;
                            ?>
                            <div id="lang-<?php echo $lkey; ?>" class="tabcontent">
                                ...
                                <div class="adminpageconxx">
                                    ...
                                    <div class="formcon">
                                        <div class="yuzde30">
                                            <?php echo __("admin/knowledgebase/create-tags"); ?>
                                            <div class="clear"></div>
                                            <span class="kinfo"><?php echo __("admin/knowledgebase/create-tags-info"); ?></span>
                                        </div>
                                        <div class="yuzde70">
                                            <input name="tags[<?php echo $lkey; ?>]" type="text" class="tags" value="<?php echo $tags; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <?php if($lang["local"]): ?>
                                        ...
                                        <div class="formcon">
                                            <div class="yuzde30"><?php echo __("admin/knowledgebase/create-rank"); ?></div>
                                            <div class="yuzde70">
                                                <input type="text" name="rank" value="<?php echo $rank; ?>" class="yuzde10">
                                                <span class="kinfo"><?php echo __("admin/knowledgebase/create-rank-desc"); ?></span>
                                            </div>
                                        </div>

                                        <div class="formcon">
                                            <div class="yuzde30"><?php echo __("admin/knowledgebase/create-private"); ?></div>
                                            <div class="yuzde70">

                                                <input<?php echo $private ? ' checked' : ''; ?> id="private" type="checkbox" name="private" value="1" class="sitemio-checkbox">
                                                <label for="private" class="sitemio-checkbox-label"></label>
                                                <span class="kinfo"><?php echo __("admin/knowledgebase/create-private-info"); ?></span>
