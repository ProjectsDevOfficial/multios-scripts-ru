                            ...
                            <div id="bigmobil">
                                <ul id="pricing-list">
                                    ...
                                    <li>
                                        ...
                                        <div class="pricing-table-item"><input name="prices[amount][]" type="number" placeholder="<?php echo __("admin/products/add-new-product-period-amount"); ?>"></div>
                                        <div class="pricing-table-item"><input  name="prices[setup][]" type="number" placeholder="<?php echo __("admin/products/add-new-product-period-amount"); ?>"></div>
                                        ...
                                        <div class="pricing-table-item"><input name="prices[discount][]" type="number" placeholder="<?php echo __("admin/invoices/create-discount"); ?> (%)"></div>
