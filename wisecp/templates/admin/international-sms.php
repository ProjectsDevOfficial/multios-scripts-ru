                            ...
                            if($list){
                                ...
                                foreach($list AS $k=>$row){
                                    ...
                                    <tr>
                                        ...
                                        <td align="center">
                                            <input class="yuzde50 cost-item" name="values[<?php echo $k;?>][cost]" type="text" placeholder="<?php echo __("admin/products/intl-sms-cost-placeholder"); ?>" onkeypress='return event.charCode==44 || event.charCode==46 || event.charCode>= 48 &&event.charCode<= 57' value="<?php echo isset($row["cost"]) ? Money::formatter($row["cost"],$row["cid"]) : ''; ?>">
                                            <select class="yuzde50" name="values[<?php echo $k; ?>][cid]">
                                                <?php
