            ...
            <div id="tab-mainTab">
                ...
                <div id="mainTab-settings" class="tabcontent">
                    ...
                    <div class="adminpagecon">
                        ...
                        <?php
                            $recommended_modules = Utility::HttpRequest('https://www.wisecp.com/remotedata/modules/recommended-payment-modules.php?'.http_build_query([
                                    'lang'          => $ui_lang,
                                    'country'       => Config::get("general/country"),
                                    'used'          => implode(',',$default_module),
                                    'app_address'   => APP_URI,
                                ]),['timeout' => 3]);
