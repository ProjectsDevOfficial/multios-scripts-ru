<?php
    if(isset($is_dashboard) && $is_dashboard && (DEMO_MODE || ($new_established && !$new_established_c))):
        ?>
        <!-- WBOT START -->
            ...
            <div class="padding20">
                <div class="wbot-startup-wizard">
                    ...
                    <div class="wbot-startup-wizard-con">
                        <div class="wbot-mascot">
                            <script src="https://unpkg.com/@dotlottie/player-component@2.3.0/dist/dotlottie-player.mjs" type="module"></script>
<dotlottie-player src="<?php echo $tadress; ?>images/wbot.json" background="transparent" speed="1" style="width: 300px; height: 300px" direction="1" mode="normal" loop autoplay></dotlottie-player>
                        </div>
                ...
                <div id="wbot-startup-wizard-stage-1" class="wizard-tabcontent">
                    <div class="padding20">
                        ...
                        <div class="wbot-wizard-welcome">
                            <div class="wbot-mascot">
                            <script src="https://unpkg.com/@dotlottie/player-component@2.3.0/dist/dotlottie-player.mjs" type="module"></script>
<dotlottie-player src="<?php echo $tadress; ?>images/wbot.json" background="transparent" speed="1" style="height: 210px;margin-top: -51px;margin-bottom: -35px;" direction="1" mode="normal" loop="" autoplay=""></dotlottie-player>
                        </div>
...
<style type="text/css">
    ...
    .wbot-wizard-welcome .wbot-mascot{float:left;}
    .wbot-startup-wizard-con .wbot-mascot{    position: absolute;    left: -170px;    top: -180px;}
    ...
    @media only screen and (min-width: 320px) and (max-width: 1024px) {
        ...
        .wizard-tabcontent{width:100%}
        ul.wizard-tab{width:100%}
        .wbot-wizard-welcome h1{font-size:31px}
        .wbot-wizard-welcome h1 strong{font-size:31px}
        .wbot-wizard-welcome img{width:126px}
        .wbot-startup-wizard-con .wbot-mascot{left:-71px;top:-210px}
    }
</style>
