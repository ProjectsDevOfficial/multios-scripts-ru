    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1>
                    <strong><?php echo __("admin/products/page-domain-edit-doc"); ?></strong>
                </h1>
                <?php
            ...
            <div class="adminpagecon domain-extension-doc">
                ...
                <form action="<?php echo $links["controller"]; ?>" method="post" id="addNewForm">
                    <input type="hidden" name="operation" value="edit_domain_doc">
                    ...
                    <div class="formcon">
                        ...
                        <div class="yuzde70">
                            ...
                            <input type="text" name="tld" value="<?php echo $id; ?>" placeholder="<?php echo __("admin/products/domain-docs-tx4"); ?>">
                        </div>
                    </div>
                                ...
                                <?php
                                    if(isset($docs) && $docs)
                                    {
                                        foreach($docs AS $d)
                                        {
                                            ?>
                                            <div class="field-item">
                                                <input type="hidden" name="docs[<?php echo $d["id"]; ?>][id][]" value="true">
                                                <div class="template-field-option" style="display: none;">
                                                    <div class="field-option-item">
                                                        <div class="doc-option-child-item">
                                                            <?php
                                                                foreach($lang_list AS $row){
                                                                    $l_k = $row["key"];
                                                                    ?>
                                                                    <input type="text" style="<?php echo $l_k == $local_l ? '' : 'display:none;';?>" name="docs[<?php echo $d["id"]; ?>][options][name][<?php echo $l_k; ?>][]" class="yuzde90 doc-values doc-value-<?php echo $l_k; ?>" placeholder="<?php echo __("admin/users/document-filter-f-option-name"); ?>">
                                                                    <?php
                                                                }
                                                            ?>
                                                            <a class="sbtn red" href="javascript:void 0;" onclick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></a>
                                                    ...
                                                    <div class="fieldcon2">
                                                        <?php
                                                            foreach($lang_list AS $row){
                                                                $l_k = $row["key"];
                                                                ?>
                                                                <input type="text" style="<?php echo $l_k == $local_l ? '' : 'display:none;';?>" name="docs[<?php echo $d["id"]; ?>][name][<?php echo $l_k; ?>]" value="<?php echo $d["languages"][$l_k]["name"] ?? ''; ?>" class="doc-values doc-value-<?php echo $l_k; ?>" placeholder="<?php echo __("admin/products/domain-docs-tx2"); ?>">
                                                                <?php
                                                            }
                                                        ?>
                                                    </div>
                                                    <div class="fieldcon3">
                                                        <select name="docs[<?php echo $d["id"]; ?>][type]" onchange="changeType(this);" style="">
                                                            <option<?php echo $d["type"] == "text" ? ' selected' : ''; ?> value="text"><?php echo __("admin/products/domain-docs-tx5"); ?></option>
                                                            <option<?php echo $d["type"] == "file" ? ' selected' : ''; ?> value="file"><?php echo __("admin/products/domain-docs-tx6"); ?></option>
                                                            <option<?php echo $d["type"] == "select" ? ' selected' : ''; ?> value="select"><?php echo __("admin/products/domain-docs-tx9"); ?></option>
                                                        </select>

                                                        <div class="options-wrap other-wrappers formcon" style="<?php echo $d["type"] == "select" ? '' : 'display: none;'; ?>">
                                                            <div class="field-options-wrap">
                                                                <?php
                                                                    if($d["type"] == "select")
                                                                    {
                                                                                ...
                                                                                <div class="doc-option-child-item">
                                                                                    <?php
                                                                                        foreach($lang_list AS $row){
                                                                                            $l_k = $row["key"];
                                                                                            ?>
                                                                                            <input type="text" style="<?php echo $l_k == $local_l ? '' : 'display:none;';?>" name="docs[<?php echo $d["id"]; ?>][options][name][<?php echo $l_k; ?>][]" class="yuzde90 doc-values doc-value-<?php echo $l_k; ?>" value="<?php echo $d["options"][$op_k][$l_k]["name"] ?? ''; ?>" placeholder="<?php echo __("admin/users/document-filter-f-option-name"); ?>">
                                                                                            <?php
                                                                                        }
                                                                                    ?>
                                                                                    <a class="sbtn red" href="javascript:void 0;" onclick="$(this).parent().parent().remove();"><i class="fa fa-remove"></i></a>
                                                        ...
                                                        <div class="file-wrap other-wrappers formcon" style="<?php echo $d["type"] == "file" ? '' : 'display: none;'; ?>">

                                                            <div class="formcon">
                                                                <div class="yuzde30"><?php echo __("admin/users/document-filter-f-allowed-ext"); ?></div>
                                                                <div class="yuzde70">
                                                                    <input type="text" name="docs[<?php echo $d["id"]; ?>][allowed_ext]" placeholder="<?php echo __("admin/users/document-filter-f-allowed-ext-info"); ?>" value="<?php echo $d["options"]["allowed_ext"] ?? ''; ?>">
                                                                </div>
                                                            </div>
                                                            <div class="formcon">
                                                                <div class="yuzde30"><?php echo __("admin/users/document-filter-f-max-upload-fsz"); ?></div>
                                                                <div class="yuzde70">
                                                                    <input type="text" name="docs[<?php echo $d["id"]; ?>][max_file_size]" value="<?php echo $d["options"]["max_file_size"] ?? ''; ?>">
                                                                </div>
                                                            </div>
                            ...
                            <?php
                                foreach($lang_list AS $row){
                                    ...
                                    <div style="<?php echo $l_k == $local_l ? '' : 'display:none;';?>" class="doc-values doc-value-<?php echo $l_k; ?>">
                                        <textarea rows="5" name="description[<?php echo $l_k; ?>]" class="tinymce-1"><?php echo $descriptions[$l_k] ?? ''; ?></textarea>
                                    </div>
                                    <?php
                                }
                            ?>
                    ...
                    <div style="float:right;margin-top:10px;" class="guncellebtn yuzde30">
                        <a class="yesilbtn gonderbtn" id="addNewForm_submit" href="javascript:void(0);"><?php echo ___("needs/button-update"); ?></a>
                    </div>
                    <div class="clear"></div>
