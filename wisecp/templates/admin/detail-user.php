        ...
        if(isset($acAddresses) && $acAddresses){
            foreach($acAddresses AS $addr){
                ...
                <div class="adresbilgisi" id="address_<?php echo $addr["id"];?>">
                    <input type="hidden" data-name="full_name" value="<?php echo $addr["full_name"]; ?>">
                    <input type="hidden" data-name="kind" value="<?php echo $addr["kind"]; ?>">
                    <input type="hidden" data-name="company_name" value="<?php echo htmlspecialchars($addr["company_name"],ENT_QUOTES); ?>">
                    <input type="hidden" data-name="company_tax_office" value="<?php echo $addr["company_tax_office"]; ?>">
                    <input type="hidden" data-name="company_tax_number" value="<?php echo $addr["company_tax_number"]; ?>">
                    <input type="hidden" data-name="email" value="<?php echo $addr["email"]; ?>">
                    <input type="hidden" data-name="phone" value="<?php echo $addr["phone"]; ?>">
                    <input type="hidden" data-name="identity" value="<?php echo $addr["identity"]; ?>">
                    <input type="hidden" data-name="country_id" value="<?php echo $addr["country_id"]; ?>">
                    <input type="hidden" data-name="detouse" value="<?php echo $addr["detouse"] ? 1 : 0; ?>">
                    <input type="hidden" data-name="zipcode" value="<?php echo $addr["zipcode"]; ?>">
                    <input type="hidden" data-name="city" value="<?php echo $addr["city"]; ?>">
                    <input type="hidden" data-name="counti" value="<?php echo $addr["counti"]; ?>">
                    <input type="hidden" data-name="address" value="<?php echo htmlentities($addr["address"],ENT_QUOTES); ?>">
                    <div class="yuzde90">
                        - <?php echo $addr["name"]." - ".$addr["address_line"]; ?>
                        <?php if($addr["detouse"]): ?>
...
<head>
    <?php
        $plugins    = ['jquery-ui','dataTables','mio-icons','select2','voucher_codes','intlTelInput-new'];
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            ...
            $("#gsm").change(function(){
                $("#editForm input[name=gsm]").val(tel1.getNumber());
            });
            ...
            $("#manageAddressForm input[name='kind']").trigger("change");
        ...
        function addAddress(){
            ...
            manageAddress_open("<?php echo __("admin/users/detail-info-add-address"); ?>");
        ...
        function editAddress(id){
            ...
            manageAddress_open("<?php echo __("admin/users/detail-info-edit-address"); ?>");
            ...
            var kind            = $("#address_"+id+" input[data-name=kind]").val();
            var full_name       = $("#address_"+id+" input[data-name=full_name]").val();
            var comp_name       = $("#address_"+id+" input[data-name=company_name]").val();
            var comp_tax_off    = $("#address_"+id+" input[data-name=company_tax_office]").val();
            var comp_tax_num    = $("#address_"+id+" input[data-name=company_tax_number]").val();
            var email           = $("#address_"+id+" input[data-name=email]").val();
            var phone           = $("#address_"+id+" input[data-name=phone]").val();
            var identity        = $("#address_"+id+" input[data-name=identity]").val();
            var city            = $("#address_"+id+" input[data-name=city]").val();
            var counti          = $("#address_"+id+" input[data-name=counti]").val();
            var zipcode         = $("#address_"+id+" input[data-name=zipcode]").val();
            var address         = $("#address_"+id+" input[data-name=address]").val();
            var detouse         = $("#address_"+id+" input[data-name=detouse]").val();
            var country_id      = $("#address_"+id+" input[data-name=country_id]").val();
        ...
        function manageAddress_open(title)
        {
            $("#manageAddress .iziModal-header-title").html(title);
            $("#manageAddress").iziModal('open');
        }
    </script>
...
<div id="manageAddress" style="display:none">
    <form action="<?php echo $links["controller"]; ?>" method="post" id="manageAddressForm">
        <div class="padding20">
            ...
            <div class="formcon">
                <div class="yuzde30"><div class="hesapbilgititle"><?php echo __("website/account_info/address-profile-tx1"); ?></div></div>
                <div class="yuzde70">
                    <input name="full_name" type="text" placeholder="<?php echo __("website/account_info/address-profile-tx1"); ?>" value="">
                </div>
            </div>

            <?php if($user["country"] == 227): ?>
                <div class="formcon">
                    <div class="yuzde30"><div class="hesapbilgititle"><?php echo __("website/sign/up-form-identity"); ?></div></div>
                    <div class="yuzde70">
            ...
            <div class="formcon corporate-info" style="display: none;">
                <div class="yuzde30"><div class="hesapbilgititle"><?php echo __("website/sign/up-form-cname"); ?></div></div>
                <div class="yuzde70">
            ...
            <?php if(Config::get("options/sign/up/kind/corporate/company_tax_number")): ?>
                <div class="formcon">
                    <div class="yuzde30"><div class="hesapbilgititle"><?php echo __("website/sign/up-form-ctaxno"); ?></div></div>
                    <div class="yuzde70">
            ...
            <?php if(Config::get("options/sign/up/kind/corporate/company_tax_office")): ?>
                <div class="formcon">
                    <div class="yuzde30"><div class="hesapbilgititle"><?php echo __("website/sign/up-form-ctaxoff"); ?></div></div>
                    <div class="yuzde70">
            ...
            <div class="formcon">
                <div class="yuzde30"><div class="hesapbilgititle"><?php echo __("website/sign/up-form-email"); ?></div></div>
                <div class="yuzde70">
                    <input name="email" type="email" placeholder="<?php echo __("website/sign/up-form-email"); ?>" value="">
                </div>
            </div>
            <div class="formcon">
                <div class="yuzde30"><div class="hesapbilgititle"><?php echo __("website/sign/up-form-gsm"); ?></div></div>
                <div class="yuzde70">
        ...
        <div class="modal-foot-btn">
            <a style="float:right;" href="javascript:void(0);" id="manageAddressForm_submit" class="green lbtn"><?php echo __("admin/users/button-add-address"); ?></a>
        </div>
    </form>
</div>
                ...
                if(isset($loginLogs) && $loginLogs){
                    foreach($loginLogs AS $row){
                        ...
                        <tr>
                            ...
                            <td align="left"><u><a referrerpolicy="no-referrer" href="https://check-host.net/ip-info?host=<?php echo $row["ip"]; ?>" target="_blank"><?php echo $row["ip"].($row["port"] ? ' - '.$row["port"] : ''); ?></a></u></td>
                            <td align="center">
                                <?php
                                    if($row["country_code"]){
                                        $cc = $row["country_code"];
            ...
            <div class="icerikbaslik">
                ...
                <div style="float: left;">
                    ...
                    <?php
                        if($user["contract2"])
                        {
                            ?><a style="float:left;" data-tooltip="<?php echo __("admin/users/gdpr-tx36"); ?>"> <img src="<?php echo $sadress; ?>assets/images/gdpr_compliant-ok.svg" style="    height: 40px;    float: left;    margin-right: 15px;"></a><?php
                        }
                    ?>
            ...
            <div id="tab-tab"><!-- tab wrap content start -->
                            ...
                            <div class="yuzde33">
                                ...
                                <?php if($user["kind"] == "corporate" && $user["company_name"]): ?>
                                    <div class="formcon">
                                        ...
                                        <div class="yuzde70">
                                            <?php echo htmlentities($user["company_name"],ENT_QUOTES); ?>
                                        </div>
                                    </div>
                                <?php endif; ?>
                        ...
                        <form action="<?php echo $links["controller"]; ?>" method="post" id="editForm">
                            ...
                            <div class="verticaltabs" id="verticaltabs">
                                    ...
                                    <div id="tab-module"><!-- tab wrap content start -->
                                        ...
                                        <ul class="tab">
                                            <li><a href="javascript:void(0)" onclick="open_tab(this, 'user-profile','module')" data-tab="user-profile" class="tablinks active"><span><?php echo __("admin/users/detail-info-profile"); ?></span></a></li>
                                            <li><a href="javascript:void(0)" onclick="open_tab(this, 'detail-info-addresses','module')" data-tab="detail-info-addresses" class="tablinks"><span><?php echo __("admin/users/detail-info-addresses"); ?></span></a></li>
                                            <li><a href="javascript:void(0)" onclick="open_tab(this, 'detail-info-security','module')" data-tab="detail-info-security" class="tablinks"><span><?php echo __("admin/users/detail-info-security"); ?></span></a></li>
                                            <li><a href="javascript:void(0)" onclick="open_tab(this, 'detail-info-custom-fields','module')" data-tab="detail-info-custom-fields" class="tablinks"><span><?php echo __("admin/users/detail-info-custom-fields"); ?></span></a></li>
                                            <?php
                                            if(isset($c_s_m) && $c_s_m && $c_s_m != "none")
                                            {
                                            ?>
                                            <li><a href="javascript:void(0)" onclick="open_tab(this, 'stored-cards','module')" data-tab="stored-cards" class="tablinks"><span><?php echo __("website/account_info/stored-cards-1"); ?></span></a></li>
                                                <?php
                                            }
                                            ?>
                                        ...
                                        <div id="module-user-profile" class="tabcontent" style="display: block">
                                            <div class="verticaltabstitle">
                                                <h2><?php echo __("admin/users/detail-info-profile"); ?></h2>
                                            </div>
                                            <div class="module-page-content">
                                                <div>
                                                    ...
                                                    <?php if(Config::get("general/country") == "tr"): ?>
                                                        <div class="formcon">
                                                            <div class="yuzde30">T.C.K.N Zorla</div>
                                                            <div class="yuzde70">
                                                                <input<?php echo ($user["force_identity"] ?? false) ? ' checked' : ''; ?> id="force_identity" name="force_identity" value="1" type="checkbox" class="checkbox-custom">
                                                                <label for="force_identity" class="checkbox-custom-label"><span class="kinfo">Müşteri T.C.K.N doğrulamaya zorlanır.</span></label>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="formcon ac-type-wrap corporate-wrap" style="display: none;">
                                                        <div class="yuzde30"><?php echo __("admin/users/create-company-name"); ?></div>
                                                        <div class="yuzde70">
                                                            <input name="company_name" type="text" value="<?php echo htmlentities($user["company_name"],ENT_QUOTES); ?>">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="formcon">
                                                        ...
                                                        <div class="yuzde70">
                                                            ...
                                                            <input type="hidden" name="gsm" value="<?php echo $user["phone"] ? '+'.$user["phone"] : ''; ?>">
                                                        </div>
                                                    </div>
                                        ...
                                        <div id="module-detail-info-addresses" class="tabcontent">
                                            <div class="verticaltabstitle">
                                                <h2><?php echo __("admin/users/detail-info-addresses"); ?></h2>
                                            </div>
                                            <div class="module-page-content">
                                                <div>
                                                            ...
                                                            if(isset($acAddresses) && $acAddresses){
                                                                foreach($acAddresses AS $addr){
                                                                    ...
                                                                    <div class="adresbilgisi" id="address_<?php echo $addr["id"];?>">
                                                                        <input type="hidden" data-name="full_name" value="<?php echo $addr["full_name"]; ?>">
                                                                        <input type="hidden" data-name="kind" value="<?php echo $addr["kind"]; ?>">
                                                                        <input type="hidden" data-name="company_name" value="<?php echo htmlentities($addr["company_name"],ENT_QUOTES); ?>">
                                                                        <input type="hidden" data-name="company_tax_office" value="<?php echo $addr["company_tax_office"]; ?>">
                                                                        <input type="hidden" data-name="company_tax_number" value="<?php echo $addr["company_tax_number"]; ?>">
                                                                        <input type="hidden" data-name="email" value="<?php echo $addr["email"]; ?>">
                                                                        <input type="hidden" data-name="phone" value="<?php echo $addr["phone"]; ?>">
                                        ...
                                        <div id="module-detail-info-security" class="tabcontent">
                                            <div class="verticaltabstitle">
                                                <h2><?php echo __("admin/users/detail-info-security"); ?></h2>
                                            </div>
                                            <div class="module-page-content">
                                                <div>
                                        ...
                                        <div id="module-detail-info-custom-fields" class="tabcontent">
                                            <div class="verticaltabstitle">
                                                <h2><?php echo __("admin/users/detail-info-custom-fields"); ?></h2>
                                            </div>
                                            <div class="module-page-content">
                                                <div>
                                                                ...
                                                                <div class="yuzde70">
                                                                    ...
                                                                    if($field["type"] == "text"){
                                                                        ...
                                                                        foreach($parse AS $k=>$p){
                                                                            ...
                                                                            ?>
                                                                            <input<?php echo $checked;?> name="cfields[<?php echo $field["id"]; ?>][]" value="<?php echo $p;?>" class="checkbox-custom" id="cfield_<?php echo $field["id"]."_".$k; ?>" type="checkbox">
                                        ...
                                        {
                                        ?>
                                        <div id="module-stored-cards" class="tabcontent">
                                            <div class="verticaltabstitle">
                                                <h2><?php echo __("website/account_info/stored-cards-1"); ?></h2>
                                            </div>
                                            <div class="module-page-content">
                                                <div>
                                                    <?php
                                        ...
                                        <div class="adminpagecon">
                                            ...
                                            <form action="<?php echo $links["controller"]; ?>" method="post" id="updateAffiliateForm">
                                                ...
                                                <div class="formcon">
                                                    ...
                                                    <div class="yuzde70">
                                                        <input<?php echo $aff["disabled"] ? ' checked' : ''; ?> type="checkbox" name="disabled" value="1" id="aff_disable" class="checkbox-custom" onchange="if($(this).prop('checked')) $('textarea[name=disabled_note]').css('display','block'); else $('textarea[name=disabled_note]').css('display','none');">
                                                        ...
                                                        <textarea name="disabled_note" style="<?php echo $aff["disabled"] ? '' : 'display:none;'; ?>" placeholder="<?php echo __("admin/users/aff-disabled-note"); ?>"><?php echo $aff["disabled_note"]; ?></textarea>
                                                    </div>
                                                </div>
                        ...
                        <div id="Bills">
                            ...
                            <table width="100%" id="invoicesTable">
                                ...
                                <tr>
                                    ...
                                    <?php endif; ?>
                                    <?php if(Config::get("options/taxation") && Config::get("options/invoice-formalization-status")): ?>
                ...
                <?php if(Admin::isPrivilege(Config::get("privileges/ORDERS"))): ?>
                    <div id="tab-services" class="tabcontent">
                        ...
                        <div id="orders_deleteModal" style="display: none;">
                            ...
                            <div class="modal-foot-btn">
                                <a href="javascript:void(0);" id="orders_delete_ok" class="red lbtn"><i class="fa fa-check"></i> <?php echo __("admin/orders/delete-ok"); ?></a>
                            </div>
                        </div>
                ...
                <div id="tab-messages" class="tabcontent">
                    ...
                    <script>
                        ...
                        function msgb64DecodeUnicode(str) {
                        ...
                        function showMessage(id,subject){
                            ...
                            let content = msgb64DecodeUnicode($("#message_"+id).html());
