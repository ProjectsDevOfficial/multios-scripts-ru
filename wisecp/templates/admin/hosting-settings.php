            ...
            <form action="<?php echo $links["controller"]; ?>" method="post" id="updateForm">
                ...
                <div id="tab-lang"><!-- tab wrap content start -->
                    ...
                    <?php
                        ...
                        $allow_sub_hosting  = Config::get("options/allow-sub-hosting");
                            ...
                            <div id="lang-<?php echo $lkey; ?>" class="tabcontent">
                                ...
                                <div class="adminpagecon">
                                    ...
                                    <?php if($lang["local"]): ?>
                                        ...
                                        <div class="formcon">
                                            <div class="yuzde30"><?php echo __("admin/products/allow-sub-hosting"); ?></div>
                                            <div class="yuzde70">
                                                <input<?php echo $allow_sub_hosting ? ' checked' : ''; ?> type="checkbox" name="allow_sub_hosting" value="1" id="allow_sub_hosting" class="checkbox-custom">
                                                <label class="checkbox-custom-label" for="allow_sub_hosting"><span class="kinfo"><?php echo __("admin/products/allow-sub-hosting-info"); ?></span></label>
                                            </div>
                                        </div>
