        ...
        <form action="<?php echo $links["controller"]; ?>" method="post" id="adjustmentsForm">
            ...
            <div id="adjustments_table">
                ...
                <div class="adjustments_table-title">
                    ...
                    <div class="yuzde33x"><?php echo __("admin/products/domain-list-min-years"); ?></div>
                        ...
                        if(isset($list) && $list){
                            foreach($list as $k=>$row){
                                ...
                                <div class="formcon sortable-item">
                                    ...
                                    <div class="yuzde33x"><input type="text" name="values[min_years][<?php echo $id; ?>]" value="<?php echo $row["min_years"]; ?>" onkeypress='return event.charCode>= 48 &&event.charCode<= 57' style="width: 50px;"></div>
...
<head>
    ...
    <script type="text/javascript">
        ...
        function setPricing(id){
            ...
            $("option[value='"+currcy.val()+"']",currency).prop("selected",true);
