                            ...
                            <div id="lang-<?php echo $lkey; ?>" class="tabcontent">
                                ...
                                <div class="adminpagecon">
                                    ...
                                    <?php if($lang["local"]): ?>
                                        ...
                                        <div class="formcon">
                                            <div class="yuzde30"><?php echo __("admin/products/domain-dashboard-widget"); ?></div>
                                            <div class="yuzde70">

                                                <input<?php echo Config::get("options/domain-dashboard-widget") ? ' checked' : ''; ?> id="domain-dashboard-widget" type="checkbox" name="domain-dashboard-widget" value="1" class="checkbox-custom">
                                                <label for="domain-dashboard-widget" class="checkbox-custom-label">
                                                    <span class="kinfo"><?php echo __("admin/products/domain-dashboard-widget-desc"); ?></span>
                                                </label>
                                        ...
                                        <div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                ...
                                                <div class="formcon">
                                                    <input<?php echo Config::get("options/disable-affiliate-domain") ? ' checked' : ''; ?> type="checkbox" class="checkbox-custom" id="affiliate-disable" name="affiliate_disable" value="1">
                                                    <label class="checkbox-custom-label" for="affiliate-disable"><span class="kinfo"><?php echo __("admin/products/add-new-product-affiliate-disable"); ?></span></label>
                                                </div>
