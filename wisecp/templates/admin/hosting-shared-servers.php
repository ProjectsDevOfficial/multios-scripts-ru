    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div style="float: left;">
                <a href="<?php echo $links["shared-server-groups"]; ?>" class="blue lbtn"><i class="fa fa-server"></i> <?php echo __("admin/products/shared-server-tx4"); ?></a>
            </div>
            ...
            <table width="100%" id="datatable" class="table table-striped table-borderedx table-condensed nowrap">
                ...
                <tr>
                    ...
                    <th align="center"><?php echo __("admin/products/hosting-shared-servers-table-stats"); ?></th>
