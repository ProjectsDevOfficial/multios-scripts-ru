                                ...
                                <div class="adminpagecon">
                                    ...
                                    <div class="formcon addon-options">
                                        ...
                                        <div style="font-weight:600;" class="yuzde70">
                                            ...
                                            <input<?php echo $type=="checkbox" || $type=="radio" ? ' checked' : ''; ?>  type="radio" name="type[<?php echo $lkey; ?>]" value="radio" id="type-radio-<?php echo $lkey; ?>" class="radio-custom" onchange="change_option_type(this,'<?php echo $lkey; ?>');">
