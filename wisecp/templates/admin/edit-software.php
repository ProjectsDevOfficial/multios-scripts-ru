...
<head>
    <?php
        ...
        $plugins    = ['jquery-ui','tinymce-1','highlightjs','voucher_codes','dataTables'];
                            ...
                            <div class="license-type-base-content" id="key-based-content" style="<?php echo $license_type == "key" ? '' : 'display: none;';?>">
                                ...
                                <div class="formcon" style="margin: 20px 0px;">
                                    ...
                                    <div class="yuzde70">
                                        ...
                                        <a class="lbtn" href="javascript:void 0;" onclick="$('#domain-based-content,#key-based-content').css('display','none'),$('.licensemanagetype').css('display','block');"><i class="fa fa-refresh" aria-hidden="true"></i><?php echo __("admin/products/software-licensing-8"); ?></a>
                                    </div>
                                </div>
                            ...
                            <script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    orders = $('#ordersTable').DataTable({
                                        ...
                                        "bProcessing": true,
                                        "bServerSide": true,
                                        "sAjaxSource": "<?php echo Controllers::$init->AdminCRLink("orders"); ?>?operation=ajax-list&from=product&id=<?php echo $product["id"]; ?>&type=software",
                                        responsive: true,
