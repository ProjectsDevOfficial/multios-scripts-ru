                ...
                <div id="settings-detail" class="tabcontent"><!-- detial tab content start -->
                    ...
                    <div class="adminpagecon">
                        ...
                        <form action="<?php echo $links["controller"]; ?>" method="post" id="editForm">
                            ...
                            <div class="formcon server-statistics">
                                    ...
                                    <div class="productstatistics">
                                        ...
                                        <div class="adminblok" id="yesilblok">
                                            <div class="padding10">
                                                ...
                                                <h2><?php echo $monthly_total ?? ($zero_amount ?? 0); ?></h2>
                                                <h4><?php echo __("admin/products/shared-server-tx24"); ?></h4>
                                                <div class="ablokbottom"><span><?php echo __("admin/products/shared-server-tx25"); ?> <strong style="<?php echo stristr($net_total ?? '',"-") ? 'color:#f44336' : 'color:#6ca56e;'; ?>"><?php echo $net_total ?? false; ?></strong></span></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="adminblok" id="maviblok">
                                            <div class="padding10">
                                                <a href="javascript:void 0;" onclick="$('a[data-tab=services]').click();">
                                                    ...
                                                    <h2><?php echo $used ?? 0; ?></h2>
                                                    <h4><?php echo __("admin/products/shared-server-tx26"); ?></h4>
                                                    <div class="ablokbottom"><span><?php echo __("admin/products/shared-server-tx27"); ?> <strong><?php echo $remaining ?? "-"; ?></strong></span></div>
                                                </a>
                                            </div>
                                        </div>
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <input type="text" name="maxaccounts" value="<?php echo $server["maxaccounts"] > 0 ? $server["maxaccounts"] : ''; ?>" style="width: 100px;" placeholder="Ex:200" onkeypress='return event.charCode>= 48 &&event.charCode<= 57'>
                                    <span class="kinfo"><?php echo __("admin/products/add-hosting-shared-server-maxaccounts-desc"); ?></span>

                                    <div class="clear"></div>

                                    <div class="formcon">
                                        <div class="yuzde30"><?php echo __("admin/products/shared-server-tx18"); ?></div>
                                        <div class="yuzde70">

                                            <input<?php echo $server["full_alert"] ? ' checked' : ''; ?> type="checkbox" name="full_alert" value="1" class="checkbox-custom" id="full_alert">
                                            <label  class="checkbox-custom-label" for="full_alert"><span class="kinfo"><?php echo __("admin/products/shared-server-tx1"); ?></span></label>
                            ...
                            <div class="formcon">
                                <div class="yuzde30"><?php echo __("admin/products/shared-server-tx2"); ?></div>
                                <div class="yuzde70">
                                    <input type="text" name="cost_price" value="<?php echo $server["cost_price"] > 0 ? Money::formatter($server["cost_price"],($server["cost_currency"] > 0 ? $server["cost_currency"] : Config::get("general/currency"))) : ''; ?>" style="width: 100px;" onkeypress='return event.charCode==46  || event.charCode>= 48 &&event.charCode<= 57'>
                                    <select name="cost_currency" style="width: 150px;">
                                        <?php
                                            foreach(Money::getCurrencies($server["cost_currency"]) AS $currency){
                                                ?>
                                                <option<?php echo $currency["id"] == $server["cost_currency"] ? ' selected' : ''; ?> value="<?php echo $currency["id"]; ?>"><?php echo $currency["name"]." (".$currency["code"].")"; ?></option>
                                                <?php
                                            }
                                        ?>
                                    </select>
                                    <span class="kinfo"><?php echo __("admin/products/shared-server-tx3"); ?></span>
                                </div>
                            </div>
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <select name="status" style="    width: 150px;">
                                        <option<?php echo $server["status"] == "active" ? ' selected' : ''; ?> value="active"><?php echo __("admin/manage-website/situations/active"); ?></option>
                                        <option<?php echo $server["status"] == "inactive" ? ' selected' : ''; ?> value="inactive"><?php echo __("admin/manage-website/situations/inactive"); ?></option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <?php
                                if(Admin::isPrivilege(["MODULES_ROOT_LOGIN_BUTTON"]) && isset($module) && $module && method_exists($module,'use_adminArea_root_SingleSignOn'))
                                {
                                    ?>
                                    <div class="formcon">
