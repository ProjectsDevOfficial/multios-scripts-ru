<?php
    ...
    $allowApiCredentials    = Admin::isPrivilege(['SETTINGS_API_CREDENTIALS']);
?>
<!DOCTYPE html>
<html>
<head>
    <?php
        $plugins    = ['jquery-ui','jscolor','select2','jQtags','dataTables','isotope'];
...
<div id="accessibility_modal" style="display: none;" data-izimodal-title="<?php echo __("admin/settings/theme-maintenance-warning"); ?>">
    <div class="padding20">
        <p><?php echo __("admin/settings/accessibility-warning"); ?></p>


        <div class="line"></div>
        <div style="text-align:center;">
            <input type="checkbox" onchange="$('#accessibility').prop('checked',$(this).prop('checked'));" id="accessibility-warning" class="checkbox-custom">
            <label class="checkbox-custom-label" for="accessibility-warning"><span class=""><?php echo __("admin/settings/theme-maintenance-warning-tx2"); ?></span></label>
        </div>

    </div>
    <div class="modal-foot-btn">
        <a onclick="close_modal('accessibility_modal');" href="javascript:void(0);" class="red lbtn"><?php echo ___("needs/ok"); ?></a>
    </div>
</div>
        ...
        <div class="icerik">
                ...
                $(document).ready(function(){
                    ...
                    $('#accessibility').change(function(){
                        if($(this).prop('checked'))
                        {
                            ...
                            open_modal('accessibility_modal');
                        }
                    });
            ...
            <div id="tab-group">
                <ul class="tab">
                    ...
                    <?php if($allowApiCredentials): ?>
                        <li><a href="javascript:void(0)" class="tablinks" onclick="open_tab(this, 'api','group')" data-tab="api"> <?php echo __("admin/settings/tab-api"); ?></a></li>
                    <?php endif; ?>
                </ul>
                    ...
                    <div id="group-informations" class="tabcontent"><!-- tab start -->
                        ...
                        <div class="adminuyedetay">
                            <form action="<?php echo $links["controller"]; ?>" method="post" enctype="multipart/form-data" id="informationsForm">
                                ...
                                <script type="text/javascript">
                                    $(document).ready(function(){
                                        $("#social_buttons").sortable({
                                            handle: ".link-bearer",
                                            placeholder: "mio-state-highlight2",
                                        }).disableSelection();

                                        $("#social_buttons").on("click",".social-link-delete",function(){
                                            var li = $(this).closest("li");
                                            $(li).remove();
                                            $("#social_buttons").sortable("refresh");
                                        });
                                    ...
                                    function social_add() {
                                        ...
                                        $("#social_buttons").append(template);
                                        $("#social_buttons").sortable("refresh");
                                    }
                                </script>
                                ...
                                <div class="formcon">
                                    ...
                                    <div class="yuzde70">
                                        ...
                                        <ul id="social_buttons" style="padding:0;">
                                            <?php
                                        ...
                                        <form action="<?php echo $links["controller"]; ?>" method="post" enctype="multipart/form-data" id="seoForm_<?php echo $lkey; ?>">
                                            ...
                                            <div class="adminuyedetay">
                                                ...
                                                <div class="formcon">
                                                    ...
                                                    <div class="yuzde70">
                                                        <?php
                                                            $rich_url = Config::get("general/rich-url");
                                                            if(!$rich_url) $rich_url = "on";
                                                        ?>
                                                        <input<?php echo $rich_url == "on" ? ' checked' : NULL; ?> type="checkbox" name="rich-url" value="1" class="checkbox-custom" id="permalink_<?php echo $lkey; ?>">
                                                        <label class="checkbox-custom-label" for="permalink_<?php echo $lkey; ?>">
                                                ...
                                                <div class="formcon">
                                                    ...
                                                    <div class="yuzde70">
                                                        <?php
                                                            $sitemap_link = Controllers::$init->CRLink("sitemap.xml",false,$lkey);

                                                        ?>
                                                        <a target="_blank" href="<?php echo $sitemap_link; ?>"><?php echo $sitemap_link; ?></a>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="edit_content" id="edit_content_{id}">
                                                    ...
                                                    <div class="formcon">
                                                        ...
                                                        <div class="yuzde35"><strong><?php echo __("admin/settings/field-item-name"); ?>:</strong>
                                                            ...
                                                            <input id="field-{id}-invoice" type="checkbox" class="checkbox-custom" name="fields[{id}][invoice]" value="1">
                                                            <label style="margin-right: 15px; font-size: 13px;" class="checkbox-custom-label" for="field-{id}-invoice"><?php echo __("admin/settings/field-item-invoice"); ?></label>
                                                            <input id="field-{id}-signForm" type="checkbox" class="checkbox-custom" name="fields[{id}][signForm]" value="1">
                                                            <label style="margin-right: 15px; font-size: 13px;" class="checkbox-custom-label" for="field-{id}-signForm"><?php echo __("admin/settings/field-item-signForm"); ?></label>
                                                                            ...
                                                                            <div class="edit_content" id="edit_content_<?php echo $field["id"]; ?>" style="display:none;">
                                                                                ...
                                                                                <div class="formcon">
                                                                                    ...
                                                                                    <div class="yuzde35"><strong><?php echo __("admin/settings/field-item-name"); ?>:</strong>
                                                                                        ...
                                                                                        <input id="field-<?php echo $field["id"]; ?>-invoice" type="checkbox" class="checkbox-custom" name="fields[<?php echo $field["id"]; ?>][invoice]" value="1"<?php echo $field["invoice"] ? ' checked' : NULL; ?>>
                                                                                        <label style="margin-right: 15px; font-size: 13px;" class="checkbox-custom-label" for="field-<?php echo $field["id"]; ?>-invoice"><?php echo __("admin/settings/field-item-invoice"); ?></label>

                                                                                        <input id="field-<?php echo $field["id"]; ?>-signForm" type="checkbox" class="checkbox-custom" name="fields[<?php echo $field["id"]; ?>][signForm]" value="1"<?php echo $field["signForm"] ? ' checked' : NULL; ?>>
                                                                                        <label style="margin-right: 15px; font-size: 13px;" class="checkbox-custom-label" for="field-<?php echo $field["id"]; ?>-signForm"><?php echo __("admin/settings/field-item-signForm"); ?></label>
                ...
                <?php if($allowApiCredentials): ?>
                    <div id="group-api" class="tabcontent"><!-- tab start -->

                        <div class="adminpagecon">

                            <script type="text/javascript">
                                var table1,table2,api_tab,btn,result_api_key;
                                var selected = [],totalCheckboxes,totalGroupCheckbox,totalGroupSelected;

                                $(document).ready(function(){

                                    api_tab = _GET("api");
                                    if(api_tab != '' && api_tab != undefined){
                                        $("#tab-api .tablinks[data-tab='"+api_tab+"']").click();
                                    }
                                    else
                                    {
                                        $("#tab-api .tablinks:eq(0)").addClass("active");
                                        $("#tab-api .tabcontent:eq(0)").css("display","block");
                                    }

                                    $("#api_credential_modal").iziModal(get_modal_options_generate());

                                    table1 = $('#table-api-credentials').DataTable({
                                        "columnDefs": [
                                            {
                                                "targets": [0],
                                                "visible":false,
                                        ...
                                        "bProcessing": true,
                                        "bServerSide": true,
                                        "sAjaxSource": "<?php echo $links["controller"]; ?>?operation=ajax-api-credentials",
                                        responsive: true,
                                        "oLanguage":<?php include __DIR__.DS."datatable-lang.php"; ?>
                                    });

                                    table2 = $('#table-api-logs').DataTable({
                                        "columnDefs": [
                                            {
                                                "targets": [0],
                                                "visible":false,
                                        ...
                                        "bProcessing": true,
                                        "bServerSide": true,
                                        "sAjaxSource": "<?php echo $links["controller"]; ?>?operation=ajax-api-logs",
                                        responsive: true,
                                        "oLanguage":<?php include __DIR__.DS."datatable-lang.php"; ?>
                                    });
                                    ...
                                    $("#apiCredentialForm_submit").on("click",function(){
                                        MioAjaxElement(this,{
                                            waiting_text: waiting_text,
                                            progress_text: progress_text,
                                            result:"apiCredentialForm_handle",
                                        });
                                    });

                                    $('#copy-btn').click(function(){
                                        btn = $(this);
                                        let text = $("#result-api-key").val();
                                        window.navigator.clipboard.writeText(text).then(x => {
                                            btn.html("<?php echo __("admin/settings/api-text3"); ?>");
                                            setTimeout(function (){
                                                btn.html("<?php echo __("admin/settings/api-text22"); ?>");
                                            },1000);
                                        });
                                    });
                                ...
                                function api_credential_modal(type,details){
                                    $("#api_credential_form_con").css("display","block");
                                    $("#api_credential_create_result").css("display","none");
                                    $("#").css("display","block");
                                    $("#api_credential_modal input[name=operation]").val('create_api_credential');
                                    $("#api_credential_modal input[name=id]").val('0');
                                    $("#api_credential_modal input[name=name]").val('');
                                    $("#api_credential_modal textarea[name=ips]").val('');
                                    $("#api_credential_modal input[type=checkbox]").prop('checked',false);

                                    $("#api_credential_modal").iziModal('open');

                                    $('.privilegescheckbox').isotope({
                                        itemSelector: '.privilegesselect'
                                    });

                                    if(type === "create")
                                    {
                                        $("#api_credential_modal").iziModal("setTitle","<?php echo htmlentities(__("admin/settings/api-text1"),ENT_QUOTES); ?>");
                                        $("#apiCredentialForm_submit").html("<?php echo ___("needs/button-create"); ?>");
                                    }
                                    else if(type === "detail")
                                    {
                                        $("#api_credential_modal").iziModal("setTitle","<?php echo htmlentities(__("admin/settings/api-text2"),ENT_QUOTES); ?>");
                                        $("#apiCredentialForm_submit").html("<?php echo ___("needs/button-update"); ?>");

                                        $("#api_credential_modal input[name=operation]").val('update_api_credential');
                                        $("#api_credential_modal input[name=id]").val(details.id);
                                        $("#api_credential_modal input[name=name]").val(details.name);
                                        $("#api_credential_modal textarea[name=ips]").val(details.ips.length > 0 ? details.ips.join("\n") : '');
                                        $(details.permissions).each(function(k,v){
                                            $("#api_credential_modal input[value='"+v+"']").trigger('click');
                                        });
                                    }
                                }
                                function apiCredentialForm_handle(result) {
                                    let solve = getJson(result);
                                    if(solve.status === "error")
                                        alert_error(solve.message,{timer:5000});
                                    else if(solve.status === "successful")
                                    {
                                        if($("#api_credential_modal input[name=operation]").val() === "create_api_credential")
                                        {
                                            result_api_key = solve.api_key;
                                            alert_success(solve.message,{timer:5000});
                                            table1.ajax.reload();
                                            $("#api_credential_form_con").fadeOut(500,function(){
                                                $("#api_credential_create_result").fadeIn(500);
                                                $("#result-api-key").val(result_api_key);
                                            });
                                        }
                                        else
                                        {
                                            $("#api_credential_modal").iziModal('close');
                                            alert_success(solve.message,{timer:5000});
                                            table1.ajax.reload();
                                        }
                                    }
                                ...
                                function copyApiKey(el){
                                    btn = $(el);
                                    let text = btn.data("key");
                                    window.navigator.clipboard.writeText(text).then(x => {
                                        btn.attr("data-tooltip","<?php echo __("admin/settings/api-text3"); ?>");
                                        setTimeout(function (){
                                            btn.attr("data-tooltip","<?php echo __("admin/settings/api-text22"); ?>");
                                        },1000);
                                    });
                                }
                                function DetailApiCredential(el){
                                    btn = $(el);
                                    let details = b64DecodeUnicode(btn.data("details"));
                                    details     = getJson(details);
                                    api_credential_modal("detail",details);
                                }
                                function DeleteApiCredential(el,id) {

                                    if(!confirm("<?php echo str_replace('"','\"',___("needs/delete-are-you-sure")); ?>"))
                                        return false;
                                    ...
                                    let request = MioAjax({
                                        ...
                                        action:"<?php echo $links["controller"]; ?>",
                                        method:"POST",
                                        data:{operation:"delete_api_credential",id:id}
                                    },true,true);
                                    request.done(function(result){
                                        let solve = getJson(result);
                                        if(solve !== false)
                                ...
                                function DeleteAllApiLogs(el) {
                                    ...
                                    let request = MioAjax({
                                        ...
                                        action:"<?php echo $links["controller"]; ?>",
                                        method:"POST",
                                        data:{operation:"delete_all_api_logs"}
                                    },true,true);
                                    request.done(function(result){
                                        let solve = getJson(result);
                                        if(solve !== false)
                                ...
                                function ApiLogDetail(el){
                                    btn = $(el);
                                    let details = b64DecodeUnicode(btn.data("details"));
                                    details     = getJson(details);
                                    open_modal("api_log_detail");

                                    $("#request_header").html(details.request_header);
                                    $("#request_body").html(details.request_body);
                                    $("#response_body").html(details.response);

                                }
                            </script>

                            <div id="api_credential_modal" data-izimodal-width="1024px" data-izimodal-title="<?php echo __("admin/settings/api-text1"); ?>" style="display: none;">
                                <div id="api_credential_form_con">
                                    <form action="<?php echo $links["controller"]; ?>" method="post" id="apiCredentialForm">
                                        <input type="hidden" name="operation" value="create_api_credential">
                                        <input type="hidden" name="id" value="0">

                                        <div class="padding20">

                                            <div class="formcon">
                                                <div class="yuzde30"><?php echo __("admin/settings/api-text4"); ?></div>
                                                <div class="yuzde70">
                                            ...
                                            <div class="formcon">
                                                <div class="yuzde30"><?php echo __("admin/settings/api-text5"); ?></div>
                                                <div class="yuzde70">
                                                    <textarea rows="5" name="ips" placeholder="<?php echo __("admin/settings/api-text6"); ?>"></textarea>
                                                    <span class="kinfo"><?php echo __("admin/settings/api-text7"); ?></span>
                                                </div>
                                            </div>

                                            <div class="formcon" style="border-bottom: none;">
                                                <div class="yuzde30"><?php echo __("admin/settings/api-text8"); ?></div>
                                            </div>

                                            <div class="privilegesselect" style="background:rgba(6,230,33,0.27)">
                                                <div class="padding15">
                                                    <input class="checkbox-custom form-check-input checkbox" id="cbx-select-all" type="checkbox" value="Group A 1" />
                                                    <label class="checkbox-custom-label form-check-label" for="cbx-select-all">
                                                        <strong><?php echo ___("needs/select-allOf"); ?></strong>
                                                    </label>
                                                    <br>
                                                </div>
                                            </div>
                                            ...
                                            <div class="privilegescheckbox" style="position: relative; height: 1422.4px;">
                                                <div class="clear"></div>
                                                <?php
                                                    if($api_actions)
                                                    {
                                                        foreach($api_actions AS $groupk => $groupd)
                                                        {
                                                            ?>
                                                            <div class="privilegesselect">
                                                                <div class="padding15">
                                                                    <input class="checkbox-custom form-check-input checkbox cbx-select-group" id="cbx-select-group-<?php echo $groupk; ?>" type="checkbox" value="<?php echo $groupk; ?>" />
                                                                    <label class="checkbox-custom-label form-check-label" for="cbx-select-group-<?php echo $groupk; ?>"><strong><?php echo $groupd["name"]; ?> <i class="fa fa-caret-down"></i></strong></label>

                                                                    <div class="privilegescontent">
                                                                        <?php
                                                                            foreach($groupd["items"] AS $gi)
                                                                            {
                                                                                ?>
                                                                                <input name="permissions[]" class="checkbox-custom form-check-input checkbox cbx-group cbx-group-<?php echo $groupk; ?>" id="cbx-group-<?php echo $groupk."-".$gi; ?>" type="checkbox" value="<?php echo $groupk."/".$gi; ?>" data-group="<?php echo $groupk; ?>" data-id="<?php echo $gi; ?>" />
                                                                                <label class="checkbox-custom-label form-check-label" for="cbx-group-<?php echo $groupk."-".$gi; ?>"><?php echo $gi; ?></label>
                                                                                <?php
                                                                            }
                                                                        ?>
                                                                    </div>
                                        ...
                                        <div class="modal-foot-btn">
                                            <a class="lbtn green" id="apiCredentialForm_submit" href="javascript:void 0;"><?php echo ___("needs/button-create"); ?></a>
                                        </div>
                                    </form>
                                </div>
                                <div id="api_credential_create_result" style="display: none;">
                                    <div class="padding20">
                                        <p style="text-align: center; font-size:14pt;"><?php echo __("admin/settings/api-text9"); ?></p>
                                        <div style="text-align: center;">
                                            <input readonly onclick="$(this).select();" id="result-api-key" rows="5" placeholder="API Key" value="" style="padding:7px; width: 50%;">
                                        </div>
                                    </div>
                                    <div class="modal-foot-btn">
                                        <a id="copy-btn" class="lbtn blue" href="javascript:void 0;"><?php echo __("admin/settings/api-text22"); ?></a>
                                    </div>
                                </div>
                            </div>

                            <div id="api_log_detail" data-izimodal-width="1024px" data-izimodal-title="<?php echo ___("needs/button-detail"); ?>" style="display: none;">
                                <div class="padding20">

                                    <h4>Request Header</h4>
                                    <pre><code id="request_header"></code></pre>

                                    <div class="line"></div>

                                    <h4>Request Body</h4>
                                    <pre><code id="request_body"></code></pre>

                                    <div class="line"></div>

                                    <h4>Response</h4>
                                    <pre><code id="response_body"></code></pre>
                            ...
                            <div id="tab-api">
                                <ul class="tab">
                                    <li><a href="javascript:void(0)" class="tablinks" onclick="open_tab(this, 'credentials','api')" data-tab="credentials"><?php echo __("admin/settings/api-text10"); ?></a></li>
                                    <li><a href="javascript:void(0)" class="tablinks" onclick="open_tab(this, 'logs','api')" data-tab="logs"><?php echo __("admin/settings/api-text11"); ?></a></li>
                                </ul>


                                <div id="api-credentials" class="tabcontent">

                                    <div class="blue-info">
                                        <div class="padding20">
                                            <i class="fa fa-info-circle"></i>
                                            <p>
                                                <?php echo __("admin/settings/api-text12"); ?>
                                            </p>
                                        </div>
                                    </div>

                                    <a class="lbtn green" href="javascript:api_credential_modal('create');"><i class="fa fa-plus"></i> <?php echo ___("needs/button-create"); ?></a>

                                    <div style="float: right;">
                                        <strong>API URL</strong>: <span style="-webkit-user-select: all;-moz-user-select: all;-ms-user-select: all;user-select: all;"><?php echo Controllers::$init->CRLink("api")."/"; ?></span>
                                    </div>


                                    <table style="width: 100%;" id="table-api-credentials" class="table table-striped table-borderedx table-condensed nowrap">
                                        <thead>
                                        <tr>
                                            <th>#</th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text4"); ?></th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text13"); ?></th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text8"); ?></th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text14"); ?></th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text21"); ?></th>
                                ...
                                <div id="api-logs" class="tabcontent">

                                    <div class="blue-info">
                                        <div class="padding20">
                                            <i class="fa fa-info-circle"></i>
                                            <p><?php echo __("admin/settings/api-text15"); ?></p>
                                        </div>
                                    </div>

                                    <a href="javascript:void 0;" class="lbtn red" onclick="DeleteAllApiLogs(this);" style="float:right;"><i class="fa fa-trash"></i> <?php echo __("admin/settings/api-text20"); ?></a>

                                   <div class="clear"></div>

                                    <table style="width: 100%;" id="table-api-logs" class="table table-striped table-borderedx table-condensed nowrap">
                                        <thead>
                                        <tr>
                                            <th>#</th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text16"); ?></th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text17"); ?></th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text18"); ?></th>
                                            <th data-orderable="false"><?php echo __("admin/settings/api-text19"); ?></th>
