...
<head>
    ...
    <script>
        ...
        function deleteProduct(id,name){
            ...
            $("#DeleteModal #delete_ok").click(function(){
                var request = MioAjax({
                    button_element:this,
            ...
            $("#DeleteModal .delete_no").click(function(){
                close_modal("DeleteModal");
            });
                ...
                <?php
                    ...
                    if($groups){
                        foreach($groups AS $_group){
                            ...
                            if($_group["id"] == $group["id"]) continue;
                            ?>
                            <option value="special-<?php echo $_group["id"]; ?>"><?php echo $_group["title"]; ?></option>
                            <?php
                        }
                    }
                ?>
...
<div class="clear"></div><br>
    ...
    <div class="modal-foot-btn">
        <a href="javascript:void(0);" class="delete_ok lbtn red"><?php echo __("admin/products/delete-ok"); ?></a>
    </div>
</div>
