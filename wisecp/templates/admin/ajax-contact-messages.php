<?php
    ...
    if(isset($list) && $list){
        foreach($list AS $i=>$row){
            ...
            <span class="message-email" style="display: none">'.$row["email"].'</span>
            <span class="message-phone" style="display: none">'.$row["phone"].'</span>
            <span class="message-ip" style="display: none">'.$row["ip"].'</span>
