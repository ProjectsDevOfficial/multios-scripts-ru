...
<head>
    ...
    <script type="text/javascript">
        ...
        function run_transaction(btn_k,btn_el,post_fields){
            var data1   = {operation:  "operation_special_automation",use_method: btn_k};
    ...
    <div class="icerik-container">
        <div class="icerik">
            ...
            <div class="icerikbaslik">
                <h1><strong><?php echo __("admin/orders/page-special-detail",['{name}' => $order["name"]]); ?></strong></h1>
            ...
            <div id="tab-content"><!-- tab wrap content start -->
                <ul class="tab">
                    ...
                    <?php if($privOperation && $order["period"] != "none" && $order["status"] == "active"): ?>
                        <li>
                            <a href="javascript:void(0)" class="tablinks" onclick="open_tab(this, 'updown','content')" data-tab="updown"><i class="fa fa-plus-circle" aria-hidden="true"></i>  <?php echo __("admin/orders/detail-content-tab-updown"); ?></a>
                        </li>
                    <?php endif; ?>
                ...
                <div id="content-detail" class="tabcontent"><!-- detail tab content start -->
                    ...
                    <div class="adminpagecon">
                        ...
                        <form action="<?php echo $links["controller"]; ?>" method="post" id="detailForm" enctype="multipart/form-data">
                                 ...
                                 <div class="formcon">
                                     <div class="yuzde30">
                                         ...
                                         <?php
                                             ...
                                             {
                                                 ?>
                                                 <a class="sbtn" href="<?php echo Controllers::$init->AdminCRLink("products-2",[$order["type"]."-".$order["type_id"],"edit"])."?id=".$product["id"]; ?>" target="_blank"><i class="fa fa-external-link"></i></a>
                                                 <?php
                                             }
                                         ?>
                                     </div>
                            ...
                            <?php if($privOperation): ?>
                                <div class="formcon" id="applyOperation_wrap">
                                    ...
                                    <div class="yuzde70">
                                        ...
                                        <?php if($order["status"] != "waiting" && $order["status"] != "completed"): ?>
                                            <input data-supported="true" type="radio" class="radio-custom" id="apply_completed" name="apply" value="completed">
                                            <label class="radio-custom-label" for="apply_completed" style="margin-left: 10px;"><?php echo __("admin/orders/status-completed2"); ?></label>
                                        <?php endif; ?>
                            ...
                            <div class="formcon">
                                <div class="yuzde30"><?php echo __("admin/orders/detail-domain"); ?></div>
                                <div class="yuzde70">
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <input name="ip" type="text" value="<?php echo isset($order["options"]["ip"]) ? $order["options"]["ip"] : ''; ?>">
                                </div>
                            </div>
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <input class="yuzde25" id="duedate" name="duedate" type="date" value="<?php echo substr($order["duedate"],0,4) != "1881" && substr($order["duedate"],0,4) != "1970" ? DateManager::format("Y-m-d",$order["duedate"]) : '';?>" placeholder="YYYY-MM-DD" autocomplete="off">
                                    <input class="yuzde25" onkeypress='return event.charCode==58 || event.charCode>= 48 &&event.charCode<= 57' maxlength="5" type="time" name="duetime" value="<?php echo substr($order["duedate"],0,4) != "1881" && substr($order["duedate"],0,4) != "1970" ? DateManager::format("H:i",$order["duedate"]) : ''; ?>">
                                </div>
                            </div>
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <input class="yuzde25" id="suspend_date" name="suspend_date" type="date" value="<?php echo substr($order["suspend_date"],0,4) == "0000" || substr($order["suspend_date"],0,4) == "1881" || substr($order["suspend_date"],0,4) == "1970" ? '' : $order["suspend_date"]; ?>" placeholder="YYYY-MM-DD" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <input class="yuzde25" id="cancel_date" name="cancel_date" type="date" value="<?php echo substr($order["cancel_date"],0,4) == "0000" || substr($order["cancel_date"],0,4) == "1881" || substr($order["cancel_date"],0,4) == "1970" ? '' : $order["cancel_date"]; ?>" placeholder="YYYY-MM-DD" autocomplete="off">
                                </div>
                            </div>
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <input class="yuzde50" id="process_exemption_date" name="process_exemption_date" type="date" value="<?php echo substr($order["process_exemption_date"],0,4) != "1881" && substr($order["process_exemption_date"],0,4) != "1970" ? DateManager::format("Y-m-d",$order["process_exemption_date"]) : '';?>" placeholder="YYYY-MM-DD" autocomplete="off">
                                    <div class="clear"></div>
                            ...
                            <div class="formcon">
                                <div class="yuzde30"><?php echo __("admin/orders/detail-delivery-file"); ?> <br><span style="font-weight:normal"><?php echo __("admin/orders/detail-delivery-file-ex"); ?></span></div>
                                <div class="yuzde70">
                                    <input name="delivery-file-button-title" type="text" placeholder="<?php echo __("admin/orders/detail-delivery-file-button-title"); ?>" value="<?php echo $delivery_file_button_title; ?>">
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <input name="delivery-title-name" type="text" placeholder="<?php echo __("admin/orders/detail-delivery-title-name"); ?>" value="<?php echo $delivery_title_name; ?>">
                                    <textarea name="delivery-title-description" placeholder="<?php echo __("admin/orders/detail-delivery-title-description"); ?>"><?php echo $delivery_title_description; ?></textarea>
                ...
                <div id="content-automation" class="tabcontent">
                    ...
                    <?php
                        $selected_module         = $order["module"];
                        $established             = isset($options["config"]) && $options["config"];
                    ?>

                    <div class="adminpagecon">

                        <form action="<?php echo $links["controller"]; ?>" method="post" id="edit_automation_form">
                            <input type="hidden" name="operation" value="operation_special_automation">
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <script type="text/javascript">
                                        $(document).ready(function(){
                                            ...
                                            <?php if($selected_module != "none"): ?>
                                            change_module_trigger();
                                            <?php endif; ?>

                                            $("select[name=module]").change(change_module_trigger);
                                        });

                                        function change_module_trigger(){
                                            ...
                                            if(module === "none" || !module){
                                                ...
                                                var request = MioAjax({
                                                    ...
                                                    method:"POST",
                                                    data:{
                                                        operation:"get_special_order_automation_info",
                                                        module:module,
                                                        order_id:<?php echo $order["id"]; ?>,
                                                    }
                                                },true,true);
                                    ...
                                    <select name="module" id="select-module">
                                        <option value="none"><?php echo ___("needs/select-your"); ?></option>
                                        <?php
                                                    ...
                                                    <optgroup label="<?php echo $g_name; ?>">
                                                        <?php
                                                            foreach($_modules AS $m_k=>$module){
                                                                ?>
                                                                <option<?php echo $m_k == $selected_module ? ' selected' : ''; ?> value="<?php echo $m_k;?>"><?php echo $module["lang"]["name"]; ?></option>
                                                                <?php
                                                            }
                                                        ?>
                                                    </optgroup>
                            ...
                            <div id="module_data_loader" style="display:none;text-align:center;">
                                <div class="clear"></div>
                                <div class="load-wrapp">
                                    <p><strong><?php echo ___("needs/processing"); ?>...</strong><br><?php echo ___("needs/please-wait"); ?></p>
                                    <div class="load-7">
                                        <div class="square-holder">
                                            <div class="square"></div>
                                        </div>
                                        ...
                                        foreach($blocks AS $block){
                                            ...
                                            <li class="yuzde30" style="display:inline-block;margin:15px;">
                                                <div class="yuzde90">
                                                    ...
                                                    <textarea style="resize: none;" rows="6" name="blocks[description][]"  placeholder="<?php echo __("admin/orders/detail-blocks-description"); ?>"><?php echo htmlentities($block["description"]); ?></textarea>
                                                </div>
                                                <div class="yuzde10" style="float:right;">
                                                    <a class="bearer sbtn" style="cursor: move;margin-bottom:5px;"><i class="fa fa-arrows-alt"></i></a>
                                                    <div class="clear"></div>
                    ...
                    <div class="adminpageconx" id="AddonList">
                            ...
                            <div class="padding20">
                                ...
                                <form id="addMyAddonForm" action="<?php echo $links["controller"]; ?>" method="post">
                                    ...
                                    <div class="formcon">
                                        ...
                                        <div class="yuzde70">
                                            <select name="status" onchange="if($(this).val()==='suspended') $(this).next('input[name=suspended_reason]').css('display','block'); else $(this).next('input[name=suspended_reason]').css('display','none').val('');">
                                                <?php
                                            ...
                                            <?php if(version_compare(License::get_version(),'3.1.9','>')): ?>
                                                <input type="text" name="suspended_reason" value="" style="display: none" id="suspended_reason" placeholder="<?php echo __("admin/orders/suspended-reason"); ?>">
                                            <?php endif; ?>
                                        </div>
                                    </div>
                        ...
                        <script type="text/javascript">
                            ...
                            function editMyAddon(id){
                                ...
                                var s_reason     = $("#addon-"+id+" input[name=suspended_reason]").val();
                                ...
                                if(status === "suspended")
                                    $("#suspended_reason").css('display','block').val(s_reason);
                                else
                                    $("#suspended_reason").css('display','none').val('');
                                        ...
                                        <div class="formcon">
                                            ...
                                            <div class="yuzde70">
                                                <?php
                                                    ...
                                                    }elseif($rtype == "input" || $rtype == "password" || $rtype == "select" || $rtype == "radio"){
                                                        ?>
                                                    ...
                                                    if($upgproducts["prices"]){
                                                        foreach($upgproducts["prices"] AS $pid=>$prices){
                                                            ...
                                                            <div class="formcon upgrade-product-prices" style="display: none;" id="upgrade_product_<?php echo $pid;?>_prices">
                                                                ...
                                                                <select name="sprice" disabled onchange="upgrade_sprice(this.options[this.selectedIndex]);">
                                                                    <?php
                                ...
                                <div id="cancelled-warning" style="display: none;" data-izimodal-title="<?php echo __("admin/orders/cancelled-submit"); ?>">
                                    <div class="padding20">
                                        ...
                                        <div align="center">
                                            ...
                                            <div class="clear"></div>
                                            <div class="yuzde50">
                                                <a href="javascript:void(0);" id="cancelledForm_submit" class="gonderbtn redbtn"><i class="fa fa-check"></i> <?php echo __("admin/orders/cancelled-ok"); ?></a>
                                            </div>
                                            <div class="yuzde50">
                                                <a href="javascript:void(0);close_modal('cancelled-warning');" class="gonderbtn yesilbtn"><i class="fa fa-ban"></i> <?php echo __("admin/orders/cancelled-no"); ?></a>
                                            </div>
                                        </div>
