    ...
    <script type="text/javascript">
            ...
            $("#load-template")
                ...
                .change(function(){
                    ...
                    else
                    {
                        ...
                        $('input[name=select_newsletter]').prop('checked',false);
                        $('#BulkMailForm textarea[name=newsletter]').val('');
        ...
        function reload_contact_list(){
            ...
            if(cc != ''){
                ...
                total_send_count    = ccSplit.length;
            }else{
                total_send_count       = 0;
            }
            ...
            if(newsletter != ''){
                ...
                total_send_count           += ntSplit.length;
            }
            ...
            request.done(function(result){
                if(result != ''){
                    ...
                    if(solve !== false){
                        ...
                        $("#users_count").html(total_send_count);
                        ...
                        $(".result_count").html(resultCon.replace("{count}",'<strong>'+total_send_count+'</strong>'));
                    }else
                        console.log(result);
                }
            });
