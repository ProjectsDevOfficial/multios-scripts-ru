            ...
            <div class="adminuyedetay">
                ...
                <form action="<?php echo $links["controller"]; ?>" method="post" id="addNewForm">
                    ...
                    <div class="formcon">
                        ...
                        <div class="yuzde70">
                            <input type="checkbox" name="recurring" value="1" class="checkbox-custom" id="enable-recurring">
                            <label class="checkbox-custom-label" for="enable-recurring"></label>
                            <?php
                                $input = <<<HTML
<input type="number" pattern="\d*" name="recurring_num" value="0" class="yuzde5" maxlength="11" style="margin-top: -7px;">
HTML;
                            ?>
                    ...
                    <div class="formcon">
                        ...
                        <div class="yuzde70">
                            <input type="checkbox" class="checkbox-custom" name="onetime_use_per_order" id="onetime_use_per_order" value="1">
                    ...
                    <div class="formcon" style="display: none;">
                        ...
                        <div class="yuzde70">
                            <input type="checkbox" class="checkbox-custom" name="used_in_invoices" id="used_in_invoices" value="1">
