                    ...
                    <div class="adminpagecon">
                        ...
                        <form action="<?php echo $links["controller"]; ?>" method="post" id="editForm" enctype="multipart/form-data">
                            ...
                            <?php if(Config::get("options/taxation") && Config::get("options/invoice-formalization-status")): ?>
                                <div class="formcon" id="taxed_wrap">
                            ...
                            <div class="formcon change-status-wrap is-paid is-refund is-waiting is-cancelled" id="pmethod-wrap" style="display: none;">
                                ...
                                <div class="yuzde70">
                                    <div class="formcon">
                                        ...
                                        <select name="pmethod" class="width200" onchange="change_pmethod(this);">
                                            ...
                                            <?php
                                                ...
                                                if(!isset($pmethods[$invoice["pmethod"]]))
                                                {
                                                    ?>
                                                    <option value="<?php echo $invoice["pmethod"]; ?>"><?php echo $invoice["pmethod"]; ?></option>
                                                    <?php
                                                }
                                            ?>
                                        </select>
                                    ...
                                    <?php elseif(strlen($invoice["pmethod_msg"]) > 1 && $invoice["status"] != "unpaid" && $invoice["pmethod"] != "Balance"): ?>
                                        <div class="formcon">
                                            <div class="yuzde30"><?php echo __("admin/orders/modal-status-message"); ?></div>
                                            <div class="yuzde70">
                                                <?php
                                            ...
                                            foreach($discounts["items"] AS $d_type => $d_vs)
                                            {
                                                foreach($d_vs AS $d_k => $d_v)
                                                {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td align="center">
                                                            <input class="yuzde20" style="width:100px;text-align: center;font-weight: bold;" name="discounts[<?php echo $d_type; ?>][<?php echo $d_k; ?>]" placeholder="<?php echo $place_holder_amount; ?>" type="text" value="<?php echo Money::formatter($d_v["amountd"],$invoice["currency"]); ?>" onkeypress='return event.charCode==44 || event.charCode==46 || event.charCode>= 48 &&event.charCode<= 57' data-calculate-amount="true">
                                                        </td>
                                                    </tr>
                                                    <?php
                                                }
                ...
                <div id="tab-informations" class="tabcontent">
                    ...
                    <div class="adminpagecon">
                        <form action="<?php echo $links["controller"]; ?>" method="post" id="informationsForm">
                            ...
                            <div class="formcon">
                                <div class="yuzde30"><?php echo __("admin/invoices/invoice-number"); ?></div>
                                <div class="yuzde70">
                                    <input type="text" name="number" style="width:150px;" value="<?php echo $invoice["number"]; ?>">
                                </div>
                            </div>
