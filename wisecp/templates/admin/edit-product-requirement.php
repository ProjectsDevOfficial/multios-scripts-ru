                                ...
                                <div class="adminpagecon">
                                    ...
                                    <div class="formcon">
                                        ...
                                        <div style="font-weight:600;" class="yuzde70">
                                            ...
                                            <input<?php echo $type=="password" ? ' checked' : ''; ?> type="radio" name="type[<?php echo $lkey; ?>]" value="password" id="type-password-<?php echo $lkey; ?>" class="radio-custom" onchange="if($(this).prop('checked')) $('#options_wrap_<?php echo $lkey; ?>').css('display','none'); else $('#options_wrap_<?php echo $lkey; ?>').css('display','block');">
                                            <label class="radio-custom-label" for="type-password-<?php echo $lkey; ?>" style="margin-right:15px;"><?php echo __("admin/products/add-requirement-type-password"); ?></label>
