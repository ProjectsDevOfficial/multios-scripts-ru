                            ...
                            <?php
                                if($server){
                                    ...
                                    <script type="text/javascript">
                                        $(document).ready(function(){
                                            setTimeout(function(){
                                                ...
                                                request.done(function(result){
                                                    ...
                                                    var usEl = $("input[name='config[user]']");
                                                    usEl.css("width","250px");

                                                    var pwEl = $("input[name='config[password]']");
                                                        pwEl.attr('type','password');
                                                        pwEl.css("width","250px");

                                                    if(!pwEl.next('.toggle-hosting-password')[0])
                                                    {
                                                        usEl.after('<div class="clear"></div>');
                                                        pwEl.after('<a href="javascript:show_pw_toggle();" class="toggle-hosting-password" style="opacity: .5;margin-left: -30px;"><i class="fa fa-eye" aria-hidden="true"></i></a><div class="clear"></div>');
                                                    }
                                        ...
                                        function show_pw_toggle() {
                                            var xInput = $("input[name='config[password]']");
                                            var x      = xInput[0];

                                            if (x.type === "password") {
                                                $('.toggle-hosting-password i').attr('class','fa fa-eye-slash');
                                                x.type = "text";

                                            } else {
                                                $('.toggle-hosting-password i').attr('class','fa fa-eye');
                                                x.type = "password";
                                            }
                                        }
                                    </script>
