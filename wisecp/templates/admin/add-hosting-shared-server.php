            ...
            <div class="adminuyedetay">
                ...
                <form action="<?php echo $links["controller"]; ?>" method="post" id="addNewForm">
                    ...
                    <div class="formcon">
                        ...
                        <div class="yuzde70">
                            <input type="text" name="maxaccounts" value="" style="width: 100px;" placeholder="Ex:200" onkeypress='return event.charCode>= 48 &&event.charCode<= 57'>
                            ...
                            <div class="formcon">
                                ...
                                <div class="yuzde70">
                                    <input type="checkbox" name="full_alert" value="1" class="checkbox-custom" id="full_alert">
                    ...
                    <div class="formcon">
                        ...
                        <div class="yuzde70">
                            <input type="text" name="cost_price" value="" style="width: 100px;" onkeypress='return event.charCode==46  || event.charCode>= 48 &&event.charCode<= 57'>
                    ...
                    <div class="formcon">
                        ...
                        <div class="yuzde70">
                            <input type="password" name="password" value="" placeholder="<?php echo __("admin/products/add-hosting-shared-server-password-desc"); ?>">
                        </div>
                    </div>
