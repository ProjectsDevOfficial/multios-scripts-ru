        ...
        <div class="icerik">
            ...
            <div class="adminuyedetay">
                ...
                <form action="<?php echo $links["controller"]; ?>" method="post" id="editForm">
                    ...
                    <div class="formcon">
                        <div class="yuzde30"><?php echo __("admin/financial/new-coupon-recurring"); ?></div>
                        <div class="yuzde70">
                            <input<?php echo $coupon["recurring"] ? ' checked' : ''; ?> type="checkbox" name="recurring" value="1" class="checkbox-custom" id="enable-recurring">
                            <label class="checkbox-custom-label" for="enable-recurring"></label>
                            <?php
                                $input = <<<HTML
<input type="number" pattern="\d*" name="recurring_num" value="{$coupon["recurring_num"]}" class="yuzde5" maxlength="11" style="margin-top: -7px;">
HTML;
                            ?>
                            <span class="kinfo"><?php echo __("admin/financial/new-coupon-recurring-desc",['{input}' => $input]); ?></span>
                        </div>
                    </div>
                    ...
                    <div class="formcon">
                        <div class="yuzde30"><?php echo __("admin/financial/new-coupon-onetime-use-per-order"); ?></div>
                        <div class="yuzde70">
                            <input<?php echo ($coupon["onetime_use_per_order"] ?? 0) ? ' checked' : ''; ?> type="checkbox" class="checkbox-custom" name="onetime_use_per_order" id="onetime_use_per_order" value="1">
                            <label for="onetime_use_per_order" class="checkbox-custom-label kinfo"><?php echo __("admin/financial/new-coupon-onetime-use-per-order-desc"); ?></label>
                        </div>
                    </div>
                    ...
                    <div class="formcon" style="display: none;">
                        <div class="yuzde30"><?php echo __("admin/financial/new-coupon-used-in-invoices"); ?></div>
                        <div class="yuzde70">
                            <input<?php echo ($coupon["used_in_invoices"] ?? false) ? ' checked' : ''; ?> type="checkbox" class="checkbox-custom" name="used_in_invoices" id="used_in_invoices" value="1">
                            <label for="used_in_invoices" class="checkbox-custom-label kinfo"><?php echo __("admin/financial/new-coupon-used-in-invoices-desc"); ?></label>
                        </div>
                    </div>
