...
<head>
    <?php
        ...
        $server_group_id= isset($options["server_group_id"]) ? $options["server_group_id"] : false;
                            ...
                            <script type="text/javascript">
                                ...
                                $(document).ready(function() {
                                    orders = $('#ordersTable').DataTable({
                                        ...
                                        "bProcessing": true,
                                        "bServerSide": true,
                                        "sAjaxSource": "<?php echo Controllers::$init->AdminCRLink("orders"); ?>?operation=ajax-list&from=product&id=<?php echo $product["id"]; ?>&type=server",
                                        responsive: true,
