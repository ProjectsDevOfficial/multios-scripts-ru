                                    ...
                                    <div class="accordions">
                                        ...
                                        <div><!-- accordion content start -->
                                            ...
                                            <?php if($lang["local"]): ?>
                                                ...
                                                <?php if($GLOBALS["group"] == 'invoice'): ?>
                                                    <div class="formcon">
                                                        <div class="yuzde30"><?php echo __("admin/notifications/send-pdf") ?: 'Send PDF'; ?></div>
                                                        <div class="yuzde70">
                                                            <input<?php echo ($template["send-pdf"] ?? true) ? ' checked' : ''; ?> name="send-pdf" type="checkbox" class="sitemio-checkbox" id="send-pdf" value="1">
                                                            <label for="send-pdf" class="sitemio-checkbox-label"></label>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
