        ...
        <div class="icerik">
            ...
            <div class="adminpagecon">
                ...
                <div class="formcon">
                    ...
                    <div class="yuzde70">
                        <div class="yuzde70">
                            <span class="croncommand">php -q <?php echo ROOT_DIR."cronjobs.php"; ?></span>
                ...
                <form action="<?php echo $links["controller"]; ?>" method="post" id="settingsForm">
                    ...
                    <div class="crongroup">
                        <div class="padding30">
                            ...
                            <div class="formcon">
                                <div class="yuzde30"><?php echo __("admin/automation/settings-domain-upcoming-renewal-notice-days"); ?></div>
                                <div class="yuzde70">

                                    <!-- First --->
                                    <div class="formcon">
                                        <div class="yuzde30"><?php echo __("admin/automation/settings-domain-upcoming-renewal-notice-first"); ?></div>
                                        <div class="yuzde70">
                                            <input class="crongroupinput" onkeypress="return event.charCode>= 48 && event.charCode<= 57" name="domain-upcoming-renewal-notice[first]" type="text" value="<?php echo $crons["tasks"]["domain-upcoming-renewal-notice"]["settings"]["first"] ?? '30'; ?>">

                                            <span class="kinfo"><?php echo __("admin/automation/settings-domain-upcoming-renewal-notice-enter-days"); ?></span>
                                        </div>
                                    </div>
                                    <!-- First -->
                                    ...
                                    <!-- Second -->
                                    <div class="formcon">
                                        <div class="yuzde30"><?php echo __("admin/automation/settings-domain-upcoming-renewal-notice-second"); ?></div>
                                        <div class="yuzde70">
                                            <input class="crongroupinput" onkeypress="return event.charCode>= 48 && event.charCode <= 57" name="domain-upcoming-renewal-notice[second]" type="text" value="<?php echo $crons["tasks"]["domain-upcoming-renewal-notice"]["settings"]["second"] ?? '7'; ?>">
                                    ...
                                    <!-- Third -->
                                    <div class="formcon">
                                        <div class="yuzde30"><?php echo __("admin/automation/settings-domain-upcoming-renewal-notice-third"); ?></div>
                                        <div class="yuzde70">
                                            <input class="crongroupinput" onkeypress="return event.charCode>= 48 && event.charCode <= 57" name="domain-upcoming-renewal-notice[third]" type="text" value="<?php echo $crons["tasks"]["domain-upcoming-renewal-notice"]["settings"]["third"] ?? '3'; ?>">
                                    ...
                                    <!-- Fourth -->
                                    <div class="formcon">
                                        <div class="yuzde30"><?php echo __("admin/automation/settings-domain-upcoming-renewal-notice-fourth"); ?></div>
                                        <div class="yuzde70">
                                            <input class="crongroupinput" onkeypress="return event.charCode>= 48 && event.charCode <= 57" name="domain-upcoming-renewal-notice[fourth]" type="text" value="<?php echo $crons["tasks"]["domain-upcoming-renewal-notice"]["settings"]["fourth"] ?? '0'; ?>">
                                    ...
                                    <!-- Fifth -->
                                    <div class="formcon">
                                        <div class="yuzde30"><?php echo __("admin/automation/settings-domain-upcoming-renewal-notice-fifth"); ?></div>
                                        <div class="yuzde70">
                                            <input class="crongroupinput" onkeypress="return event.charCode>= 48 && event.charCode <= 57" name="domain-upcoming-renewal-notice[fifth]" type="text" value="<?php echo $crons["tasks"]["domain-upcoming-renewal-notice"]["settings"]["fifth"] ?? '0'; ?>">
