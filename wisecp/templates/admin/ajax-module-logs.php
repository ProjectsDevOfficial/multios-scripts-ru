<?php
    ...
    if(isset($list) && $list){
        foreach($list AS $i=>$row){
            ...
            $detail_con = base64_encode($detail_con);
            ...
            array_push($item,'<a data-tooltip="'.__("admin/tools/actions-details").'" class="sbtn" onclick="details(\''.$detail_con.'\'); " href="javascript:void 0;"><i class="fa fa-search"></i></a>');
