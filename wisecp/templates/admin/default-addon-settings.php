<form action="<?php echo $request_uri; ?>?module=<?php echo $module->_name; ?>" method="post" id="<?php echo $module->_name; ?>_settingsForm" enctype="multipart/form-data">
    <?php if(($module->config["meta"]["opening-type"] ?? "normal") == "modal"): ?>
        <div class="padding20">
    <?php endif; ?>
    ...
    <?php if(($module->config["meta"]["opening-type"] ?? "normal") == "modal"): ?></div><?php endif; ?>
    <div class="clear"></div>

    <?php if(($module->config["meta"]["opening-type"] ?? "normal") == "modal"): ?>
        <div class="modal-foot-btn">
            <a href="javascript:void 0;" style="float:right;" class="green lbtn" id="<?php echo $module->_name; ?>_submit_button"><?php echo ___("needs/button-save"); ?></a>
        </div>
    <?php else: ?>
