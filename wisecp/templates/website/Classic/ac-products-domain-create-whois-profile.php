...
<script type="text/javascript">
    ...
    function createForm_handler(result)
    {
        if(result != ''){
...
<div class="mpanelrightcon">
    ...
    <form action="<?php echo $links["controller"]; ?>" method="post" id="createForm">
        <input type="hidden" name="operation" value="create_whois_profile">

        <div class="formcon">
            <div class="yuzde30"><?php echo __("website/account_products/domain-whois-tx7"); ?></div>
            <div class="yuzde70">
                <input type="text" name="profile_name" value="" placeholder="<?php echo __("website/account_products/domain-whois-tx7"); ?>">
            </div>
        </div>
        ...
        <div style="float: right;" class="guncellebtn yuzde30">
            <a href="javascript:void(0);" class="yesilbtn gonderbtn mio-ajax-submit" mio-ajax-options='{"result":"createForm_handler","waiting_text":"<?php echo addslashes(__("website/others/button1-pending")); ?>"}'><?php echo ___("needs/button-create"); ?></a>
        </div>
