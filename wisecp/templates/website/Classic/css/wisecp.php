<?php
    $url =  APP_URI."/templates/website/Classic/";
?>@charset "utf-8";
...
#muspanel{background-image:url(<?php echo $url; ?>images/cloudbg.jpg);background-repeat:no-repeat;background-position:center top;background-attachment:fixed}
...
input,select,textarea{font-family:'Titillium Web',sans-serif;outline:none;padding:5px;font-size:15px;color:#<?php echo $text_color; ?>;border:1px solid #ccc}
...
.header{background-position:center center;margin-bottom:10px;background-image:url(<?php echo $url; ?>images/image4.jpg);float:left;height:300px;width:100%;position:relative;z-index:55;-webkit-box-shadow:inset 0 198px 110px -45px rgba(0,0,0,0.68);-moz-box-shadow:inset 0 198px 110px -45px rgba(0,0,0,0.68);box-shadow:inset 0 198px 110px -45px rgba(0,0,0,0.68);background-size:100% auto}
...
.anascript{background-image:url(<?php echo $url; ?>images/anascript-bg.jpg);background-repeat:no-repeat;background-position:center center;float:left;text-align:center;width:100%;background-size:100% 100%;padding:25px 0;}
...
.nedenbiz{background-image:url(<?php echo $url; ?>images/nedenbizbg.jpg);background-repeat:repeat;background-position:center center;float:left;height:auto;width:100%;margin:35px 0;box-shadow: inset 0 0 70px 30px #fff;;text-align: center;}
...
.blogvehaber{background-image:url(<?php echo $url; ?>images/bloghaberbg.jpg);background-repeat:repeat;background-position:center top;float:left;width:100%;margin:35px 0;text-align:center;padding:30px 0;box-shadow:inset 0 0 70px 40px #fff}
...
.ebulten{background-image:url(<?php echo $url; ?>images/ebultenbg.jpg);background-repeat:no-repeat;background-position:center center;float:left;height:200px;width:100%;background-size:100% auto}
...
.footer{background-image:url(<?php echo $url; ?>images/footerbg.png);background-color:#2e3d44;background-size:100% auto;background-repeat:repeat;background-position:center top;float:left;height:auto;width:100%;padding:70px 0;color:#fff}
...
.cd-top{display:inline-block;height:60px;border-radius: 5px;width:60px;position:fixed;bottom:50px;right:20px;box-shadow:0 0 10px rgba(0,0,0,0.05);overflow:hidden;text-indent:100%;white-space:nowrap;background:rgba(232,98,86,0.8) url(<?php echo $url; ?>images/cd-top-arrow.svg) no-repeat center 50%;visibility:hidden;opacity:0;-webkit-transition:opacity .3s 0s,visibility 0 .3s;-moz-transition:opacity .3s 0s,visibility 0 .3s;transition:opacity .3s 0s,visibility 0 .3s}
...
.fullwidthhead{width:100%;height:auto;padding:12px 0;float:left;background-image:url(<?php echo $url; ?>images/menubg2018.jpg);position:relative;margin-top:0;background-size:100%;background-color:white}
...
#fullwidth .menu{float:left;width:100%;margin:0;background-image:url(<?php echo $url; ?>images/menubg.jpg);background-position:top center}
...
.callbacks_nav{position:relative;-webkit-tap-highlight-color:rgba(0,0,0,0);left:0;display:none;opacity:.7;z-index:3;text-indent:-9999px;overflow:hidden;text-decoration:none;height:61px;width:38px;background:transparent url(<?php echo $url; ?>images/themes.png) no-repeat left top;margin-top:-120px}
...
.sayfaustheader{background-image:url(<?php echo $url; ?>images/image4.jpg);background-repeat:no-repeat;background-position:center top;float:left;height:260px;width:100%;background-size:100% auto}
.headerwhite{background-image:url(<?php echo $url; ?>images/headerwhite.png);background-repeat:repeat;background-position:center bottom;width:100%;height:149px;display:inline-block;position:absolute;bottom:-2px}
...
.tescilucretleri table tr td{padding:10px;border-bottom:1px dotted #eee;}
...
.sepetbaslik{float:left;line-height:50px;width:100%;background:#<?php echo $color2; ?>;color:#fff;-webkit-border-radius:10px;-moz-border-radius:2px;border-radius:10px;font-size:16px;font-weight:700;z-index: 15;position: relative;}
...
.lbtn{padding:5px 15px;border:2px solid #<?php echo $color1; ?>;color:#<?php echo $color1; ?>;font-weight:600;border-radius:50px;display:inline-block;outline:none}
.lbtn:hover{color:#fff;background:#<?php echo $color1; ?>}
...
.hizmetblok tr:nth-child(1) td{font-size:15px;padding:12px;background:none;border-bottom:1px solid #eee;color:#<?php echo $color2; ?>;background:#efefef;background:-moz-linear-gradient(top,#efefef 0%,#fff 100%);background:-webkit-linear-gradient(top,#efefef 0%,#fff 100%);background:linear-gradient(to bottom,#efefef 0%,#fff 100%);filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#efefef',endColorstr='#ffffff',GradientType=0)}
...
.hesapinfobloktitle{float:left;width:100%;padding-bottom:15px;border-bottom:1px solid #eee;margin-bottom:15px;font-weight:600;font-size:18px;color:#<?php echo $color2; ?>}
...
#fullwidth .head .countryselect{line-height:normal;margin-top:10px;background-image:url(<?php echo $url; ?>images/map2.png)}
...
.categoriesproduct a:hover{background:#d7d7d7;border-bottom:2px solid #ccc;color:#<?php echo $color1; ?>}
...
.faturabilgisi .red-info h5{color:#<?php echo $text_color; ?>;font-size:16px;}
...
#megamenu #kurumsalmenu{background-image:url(<?php echo $url; ?>images/kurumsalmenubg.jpg);padding:15px 0}
