...
<a id="twitpaylas" onclick="NewWindow(this.href,'<?php echo addslashes(__("website/others/share-page")); ?>','545','600','no','center');return false" onfocus="this.blur()" target="_blank" href="https://x.com/intent/tweet?text=<?php echo urlencode($canonical_link);?>"><i class="fa-brands fa-x-twitter"></i></a>
