<?php
    $url =  APP_URI."/templates/website/Modern/";
?>@charset "utf-8";
...
.anascript{background-image:url(<?php echo $url; ?>images/anascript-bg.jpg);background-repeat:no-repeat;background-position:center center;float:left;text-align:center;width:100%;background-size:100% 100%;padding:25px 0;box-shadow:inset 0 0 70px 30px #fff}
