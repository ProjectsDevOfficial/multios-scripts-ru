...
<style>
    ...
    .invoice-coupon-area{width:300px;text-align:right;margin-top:25px;float:right}
    .invoice-coupon-area .sbtn{padding:4px 12px;border:none;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;width:auto;font-size:14px}
    .invoice-coupon-area .sbtn i{margin-right:5px}
    .invoice-coupon-area h5{font-weight:600;font-size:16px}
    .invoice-coupon-area input{width:150px}
</style>
            ...
            <script type="text/javascript">
                ...
                $(function(){
                    ...
                    $("#btn_apply_coupon").click(function(){
                        var request = MioAjax({
                            button_element: $(this),
                            waiting_text: '<i class="fas fa-spinner" style="-webkit-animation:fa-spin 2s infinite linear;animation: fa-spin 2s infinite linear;"></i> <?php echo ___("needs/button-apply"); ?>',
