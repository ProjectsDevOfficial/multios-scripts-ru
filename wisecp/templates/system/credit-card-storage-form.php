...
?>
<?php if(Filter::GET("identification_status") == "successful"): ?>
    <script type="text/javascript">
        ...
        var url = sGET("identification_status",'');
        history.pushState(false, "", url);
    </script>

<?php elseif(Filter::GET("identification_status") == "failed"): ?>
    <script type="text/javascript">
        swal(
    ...
    $(document).ready(function(){
        ...
        let
            ...
            binChecker = (value) => {
                ...
                if((numInt.length === 8 || numInt.length >= 18 && cacheNumInt !== numInt) || parseInt($("#stored_card").val()) !== 0)
                {
                    cacheNumInt = numInt;
                    let request = MioAjax({
                            ...
                            if(solve !== false){
                                ...
                                else if(solve.status === "successful")
                                {
                                    ...
                                    if(solve.card_type === "debit")
                                    {
                                        ...
                                        if(isNaN(parseInt($("#select_stored_card").val())))
...
<div class="creditcardpaypage">
        ...
        <div class="securityinfo-con">
            ...
            <div class="securityinfo-right">
                ...
                <ul>
                    ...
                    <li><?php echo __("website/payment/card-tx4"); ?></li>
                </ul>
            </div>
    ...
    <div class="creditcardinfo">
        <div class="creditcardinfo-con">
            <?php
                if($stored_cards && $checkout["data"]["type"] != "card-identification" && Config::get("modules/card-storage-module") == $checkout["data"]["pmethod"])
                {
                    ?>
                    <div class="my-registered-cards">
                        <h5><?php echo __("website/payment/card-tx15"); ?></h5>
                        <p><?php echo __("website/payment/card-tx16"); ?></p>
                        <select id="select_stored_card">
                            <option value="new">+ <?php echo __("website/payment/card-tx17"); ?></option>
                            <?php
                                foreach($stored_cards AS $stored_card)
                                {
                                    ?>
                                    <option value="<?php echo $stored_card["id"]; ?>" data-ln4="<?php echo $stored_card["ln4"]; ?>" data-name="<?php echo $stored_card["name"]; ?>" data-expirym="<?php echo $stored_card["expiry_month"]; ?>" data-expiryy="<?php echo $stored_card["expiry_year"]; ?>">**** **** **** <?php echo $stored_card["ln4"]; ?> - <?php echo $stored_card["name"]; ?> - <?php echo $stored_card["bank_name"]; ?></option>
                                    <?php
                                }
                            ?>
                        </select>
            ...
            <div class="creditcardform-con">
                ...
                <div class="creditcardinfo-left">
                    <label>
                        ...
                        <input inputmode="numeric" name="card_num" autocomplete="cc-number" id="i_card_num" placeholder="••••  ••••  ••••  ••••" type="text" value="">
                    </label>
                    <label>
                        <span class="kinfo"><?php echo __("website/payment/card-tx6"); ?></span>
                        <input name="card_name" id="i_card_name" autocomplete="cc-name" placeholder="<?php echo __("website/payment/card-tx18"); ?>" type="text" value="">
                    </label>
                    <div class="yuzde50">
                        <label >
                            <span class="kinfo"><?php echo __("website/payment/card-tx7"); ?></span>
                            <input inputmode="numeric" name="card_expiry" id="i_card_expiry" autocomplete="cc-exp" placeholder="<?php echo __("website/payment/card-tx19"); ?>" type="text" value="">
                        </label></div>
                    <div class="yuzde50">
                        <label class="yuzde50">
                            ...
                            <input inputmode="numeric" name="card_cvc" id="i_card_cvc" autocomplete="cc-csc" placeholder="CVC/CVV" type="text" maxlength="3" value="" onkeypress='return event.charCode>= 48 &&event.charCode<= 57'>
                        </label>
                    </div>
                ...
                <div class="yuzde100" style="font-weight:600;">
                    ...
                    <?php if($checkout["data"]["type"] != "card-identification" && Config::get("modules/card-storage-module") == $checkout["data"]["pmethod"]): ?>
                        <div id="savedcard_wrap">
                            <input id="savedcard" class="checkbox-custom" name="card_storage" value="1" type="checkbox">
                            <label style="padding:0;" for="savedcard" class="checkbox-custom-label"><span class="checktext"><?php echo __("website/payment/card-tx10"); ?> </span></label>
                        </div>
                    <?php endif; ?>
                    <div class="clear"></div>
                    ...
                    <?php if($checkout["data"]["type"] != "card-identification" && Config::get("modules/card-storage-module") == $checkout["data"]["pmethod"]): ?>
                        <div id="cardauto_wrap">
                            ...
                            <label for="cardauto" class="checkbox-custom-label"><span class="checktext"><?php echo __("website/payment/card-tx11"); ?></span><br>
                                <span class="kinfo"><?php echo __("website/payment/card-tx20"); ?></span></label>
                        </div>
                    <?php endif; ?>
                </div>
