<div class="stage2">
    ...
    <div class="title">v<?php echo WCP_VERSION; ?> <?php echo $lang["name"]; ?></div>
    <div style="padding:25px;">
        ...
        <div style="text-align:center;margin-top:25px;">
            ...
            <div class="clear"></div>
            <div class="stagebtn"><a class="disablebtn button" id="continue_button"><?php echo $lang["stage-text3"]; ?></a></div></div>
